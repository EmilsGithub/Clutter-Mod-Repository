...
public class PandaPlushieBlock extends AbstractPlushieBlock {
    ...
    public static final MapCodec<PandaPlushieBlock> CODEC = createCodec(PandaPlushieBlock::new);
    ...
    public ActionResult onUse(BlockState state, World world, BlockPos pos, PlayerEntity player, BlockHitResult hit) {
        ...
        if (hand.equals(Hand.MAIN_HAND) && player.getStackInHand(hand).isEmpty()) {
            world.playSound(null, pos, SoundEvents.ENTITY_PANDA_AMBIENT, SoundCategory.BLOCKS, 1.0f, 1.25f);
