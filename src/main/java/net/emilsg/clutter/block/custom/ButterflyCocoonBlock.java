...
public class ButterflyCocoonBlock extends Block {
        ...
        if (this.shouldHatchProgress(world, state)) {
            ...
            if (i < 2) {
                ...
                if (random.nextInt(10) == 0)
                    dropStack(world, pos, new ItemStack(ModItems.DECORATED_ELYTRA_SMITHING_TEMPLATE_SHARDS));
    ...
    private boolean shouldHatchProgress(World world, BlockState state) {
        ...
        boolean isNether = world.getDimensionEntry() == DimensionTypes.THE_NETHER;
