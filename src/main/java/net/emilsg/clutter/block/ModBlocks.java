...
public class ModBlocks {
    ...
    public static final Block WHITE_LAMP = registerBlock("white_lamp", new LampBlock(FabricBlockSettings.copy(Blocks.OAK_PLANKS).luminance(LampBlock.createLightLevelFromLitBlockState(12))), ModItemGroups.CLUTTER_BLOCKS);
    public static final Block LIGHT_GRAY_LAMP = registerBlock("light_gray_lamp", new LampBlock(FabricBlockSettings.copy(Blocks.OAK_PLANKS).luminance(LampBlock.createLightLevelFromLitBlockState(12))), ModItemGroups.CLUTTER_BLOCKS);
    public static final Block GRAY_LAMP = registerBlock("gray_lamp", new LampBlock(FabricBlockSettings.copy(Blocks.OAK_PLANKS).luminance(LampBlock.createLightLevelFromLitBlockState(12))), ModItemGroups.CLUTTER_BLOCKS);
    public static final Block BLACK_LAMP = registerBlock("black_lamp", new LampBlock(FabricBlockSettings.copy(Blocks.OAK_PLANKS).luminance(LampBlock.createLightLevelFromLitBlockState(12))), ModItemGroups.CLUTTER_BLOCKS);
    public static final Block BROWN_LAMP = registerBlock("brown_lamp", new LampBlock(FabricBlockSettings.copy(Blocks.OAK_PLANKS).luminance(LampBlock.createLightLevelFromLitBlockState(12))), ModItemGroups.CLUTTER_BLOCKS);
    public static final Block RED_LAMP = registerBlock("red_lamp", new LampBlock(FabricBlockSettings.copy(Blocks.OAK_PLANKS).luminance(LampBlock.createLightLevelFromLitBlockState(12))), ModItemGroups.CLUTTER_BLOCKS);
    public static final Block ORANGE_LAMP = registerBlock("orange_lamp", new LampBlock(FabricBlockSettings.copy(Blocks.OAK_PLANKS).luminance(LampBlock.createLightLevelFromLitBlockState(12))), ModItemGroups.CLUTTER_BLOCKS);
    public static final Block YELLOW_LAMP = registerBlock("yellow_lamp", new LampBlock(FabricBlockSettings.copy(Blocks.OAK_PLANKS).luminance(LampBlock.createLightLevelFromLitBlockState(12))), ModItemGroups.CLUTTER_BLOCKS);
    public static final Block LIME_LAMP = registerBlock("lime_lamp", new LampBlock(FabricBlockSettings.copy(Blocks.OAK_PLANKS).luminance(LampBlock.createLightLevelFromLitBlockState(12))), ModItemGroups.CLUTTER_BLOCKS);
    public static final Block GREEN_LAMP = registerBlock("green_lamp", new LampBlock(FabricBlockSettings.copy(Blocks.OAK_PLANKS).luminance(LampBlock.createLightLevelFromLitBlockState(12))), ModItemGroups.CLUTTER_BLOCKS);
    public static final Block CYAN_LAMP = registerBlock("cyan_lamp", new LampBlock(FabricBlockSettings.copy(Blocks.OAK_PLANKS).luminance(LampBlock.createLightLevelFromLitBlockState(12))), ModItemGroups.CLUTTER_BLOCKS);
    public static final Block LIGHT_BLUE_LAMP = registerBlock("light_blue_lamp", new LampBlock(FabricBlockSettings.copy(Blocks.OAK_PLANKS).luminance(LampBlock.createLightLevelFromLitBlockState(12))), ModItemGroups.CLUTTER_BLOCKS);
    public static final Block BLUE_LAMP = registerBlock("blue_lamp", new LampBlock(FabricBlockSettings.copy(Blocks.OAK_PLANKS).luminance(LampBlock.createLightLevelFromLitBlockState(12))), ModItemGroups.CLUTTER_BLOCKS);
    public static final Block PURPLE_LAMP = registerBlock("purple_lamp", new LampBlock(FabricBlockSettings.copy(Blocks.OAK_PLANKS).luminance(LampBlock.createLightLevelFromLitBlockState(12))), ModItemGroups.CLUTTER_BLOCKS);
    public static final Block MAGENTA_LAMP = registerBlock("magenta_lamp", new LampBlock(FabricBlockSettings.copy(Blocks.OAK_PLANKS).luminance(LampBlock.createLightLevelFromLitBlockState(12))), ModItemGroups.CLUTTER_BLOCKS);
    public static final Block PINK_LAMP = registerBlock("pink_lamp", new LampBlock(FabricBlockSettings.copy(Blocks.OAK_PLANKS).luminance(LampBlock.createLightLevelFromLitBlockState(12))), ModItemGroups.CLUTTER_BLOCKS);
    ...
    public static final Block SILVER_BUTTON = registerBlock("silver_button", new ButtonBlock(FabricBlockSettings.copy(Blocks.STONE_BUTTON), BlockSetType.IRON, 80, false), ModItemGroups.CLUTTER_BLOCKS);
    ...
    public static final Block COPPER_BUTTON = registerBlock("copper_button", new OxidizableButtonBlock(Oxidizable.OxidationLevel.UNAFFECTED, FabricBlockSettings.copy(Blocks.STONE_BUTTON), BlockSetType.IRON, 10, false), ModItemGroups.CLUTTER_BLOCKS);
    public static final Block EXPOSED_COPPER_BUTTON = registerBlock("exposed_copper_button", new OxidizableButtonBlock(Oxidizable.OxidationLevel.EXPOSED, FabricBlockSettings.copy(Blocks.STONE_BUTTON), BlockSetType.IRON, 20, false), ModItemGroups.CLUTTER_BLOCKS);
    public static final Block WEATHERED_COPPER_BUTTON = registerBlock("weathered_copper_button", new OxidizableButtonBlock(Oxidizable.OxidationLevel.WEATHERED, FabricBlockSettings.copy(Blocks.STONE_BUTTON), BlockSetType.IRON, 30, false), ModItemGroups.CLUTTER_BLOCKS);
    public static final Block OXIDIZED_COPPER_BUTTON = registerBlock("oxidized_copper_button", new OxidizableButtonBlock(Oxidizable.OxidationLevel.OXIDIZED, FabricBlockSettings.copy(Blocks.STONE_BUTTON), BlockSetType.IRON, 40, false), ModItemGroups.CLUTTER_BLOCKS);
    ...
    public static final Block GOLDEN_BUTTON = registerBlock("golden_button", new ButtonBlock(FabricBlockSettings.copy(Blocks.STONE_BUTTON), BlockSetType.IRON, 20, false), ModItemGroups.CLUTTER_BLOCKS);
    ...
    public static final Block IRON_BUTTON = registerBlock("iron_button", new ButtonBlock(FabricBlockSettings.copy(Blocks.STONE_BUTTON), BlockSetType.IRON, 60, false), ModItemGroups.CLUTTER_BLOCKS);
    ...
    public static final Block OAK_WALL_BOOKSHELF = registerBlock("oak_wall_bookshelf", new WallBookshelfBlock(FabricBlockSettings.copy(Blocks.OAK_PLANKS).luminance(WallBookshelfBlock.createLightLevelFromLitBlockState(8))), ModItemGroups.CLUTTER_BLOCKS);
    ...
    public static final Block SPRUCE_WALL_BOOKSHELF = registerBlock("spruce_wall_bookshelf", new WallBookshelfBlock(FabricBlockSettings.copy(Blocks.SPRUCE_PLANKS).luminance(WallBookshelfBlock.createLightLevelFromLitBlockState(8))), ModItemGroups.CLUTTER_BLOCKS);
    ...
    public static final Block BIRCH_WALL_BOOKSHELF = registerBlock("birch_wall_bookshelf", new WallBookshelfBlock(FabricBlockSettings.copy(Blocks.BIRCH_PLANKS).luminance(WallBookshelfBlock.createLightLevelFromLitBlockState(8))), ModItemGroups.CLUTTER_BLOCKS);
    ...
    public static final Block JUNGLE_WALL_BOOKSHELF = registerBlock("jungle_wall_bookshelf", new WallBookshelfBlock(FabricBlockSettings.copy(Blocks.JUNGLE_PLANKS).luminance(WallBookshelfBlock.createLightLevelFromLitBlockState(8))), ModItemGroups.CLUTTER_BLOCKS);
    ...
    public static final Block ACACIA_WALL_BOOKSHELF = registerBlock("acacia_wall_bookshelf", new WallBookshelfBlock(FabricBlockSettings.copy(Blocks.ACACIA_PLANKS).luminance(WallBookshelfBlock.createLightLevelFromLitBlockState(8))), ModItemGroups.CLUTTER_BLOCKS);
    ...
    public static final Block DARK_OAK_WALL_BOOKSHELF = registerBlock("dark_oak_wall_bookshelf", new WallBookshelfBlock(FabricBlockSettings.copy(Blocks.DARK_OAK_PLANKS).luminance(WallBookshelfBlock.createLightLevelFromLitBlockState(8))), ModItemGroups.CLUTTER_BLOCKS);
    ...
    public static final Block MANGROVE_WALL_BOOKSHELF = registerBlock("mangrove_wall_bookshelf", new WallBookshelfBlock(FabricBlockSettings.copy(Blocks.MANGROVE_PLANKS).luminance(WallBookshelfBlock.createLightLevelFromLitBlockState(8))), ModItemGroups.CLUTTER_BLOCKS);
    ...
    public static final Block CRIMSON_WALL_BOOKSHELF = registerBlock("crimson_wall_bookshelf", new WallBookshelfBlock(FabricBlockSettings.copy(Blocks.CRIMSON_PLANKS).luminance(WallBookshelfBlock.createLightLevelFromLitBlockState(8))), ModItemGroups.CLUTTER_BLOCKS);
    ...
    public static final Block WARPED_WALL_BOOKSHELF = registerBlock("warped_wall_bookshelf", new WallBookshelfBlock(FabricBlockSettings.copy(Blocks.WARPED_PLANKS).luminance(WallBookshelfBlock.createLightLevelFromLitBlockState(8))), ModItemGroups.CLUTTER_BLOCKS);
    ...
    public static final Block BAMBOO_WALL_BOOKSHELF = registerBlock("bamboo_wall_bookshelf", new WallBookshelfBlock(FabricBlockSettings.copy(Blocks.BAMBOO_PLANKS).luminance(WallBookshelfBlock.createLightLevelFromLitBlockState(8))), ModItemGroups.CLUTTER_BLOCKS);
    ...
    public static final Block CHERRY_WALL_BOOKSHELF = registerBlock("cherry_wall_bookshelf", new WallBookshelfBlock(FabricBlockSettings.copy(Blocks.CHERRY_PLANKS).luminance(WallBookshelfBlock.createLightLevelFromLitBlockState(8))), ModItemGroups.CLUTTER_BLOCKS);
    ...
    public static final Block TALL_WHITE_LAMP = registerBlock("tall_white_lamp", new TallLampBlock(FabricBlockSettings.copy(Blocks.OAK_PLANKS).luminance(TallLampBlock.createLightLevelFromLitBlockState(12))), ModItemGroups.CLUTTER_BLOCKS);
    public static final Block TALL_LIGHT_GRAY_LAMP = registerBlock("tall_light_gray_lamp", new TallLampBlock(FabricBlockSettings.copy(Blocks.OAK_PLANKS).luminance(TallLampBlock.createLightLevelFromLitBlockState(12))), ModItemGroups.CLUTTER_BLOCKS);
    public static final Block TALL_GRAY_LAMP = registerBlock("tall_gray_lamp", new TallLampBlock(FabricBlockSettings.copy(Blocks.OAK_PLANKS).luminance(TallLampBlock.createLightLevelFromLitBlockState(12))), ModItemGroups.CLUTTER_BLOCKS);
    public static final Block TALL_BLACK_LAMP = registerBlock("tall_black_lamp", new TallLampBlock(FabricBlockSettings.copy(Blocks.OAK_PLANKS).luminance(TallLampBlock.createLightLevelFromLitBlockState(12))), ModItemGroups.CLUTTER_BLOCKS);
    public static final Block TALL_BROWN_LAMP = registerBlock("tall_brown_lamp", new TallLampBlock(FabricBlockSettings.copy(Blocks.OAK_PLANKS).luminance(TallLampBlock.createLightLevelFromLitBlockState(12))), ModItemGroups.CLUTTER_BLOCKS);
    public static final Block TALL_RED_LAMP = registerBlock("tall_red_lamp", new TallLampBlock(FabricBlockSettings.copy(Blocks.OAK_PLANKS).luminance(TallLampBlock.createLightLevelFromLitBlockState(12))), ModItemGroups.CLUTTER_BLOCKS);
    public static final Block TALL_ORANGE_LAMP = registerBlock("tall_orange_lamp", new TallLampBlock(FabricBlockSettings.copy(Blocks.OAK_PLANKS).luminance(TallLampBlock.createLightLevelFromLitBlockState(12))), ModItemGroups.CLUTTER_BLOCKS);
    public static final Block TALL_YELLOW_LAMP = registerBlock("tall_yellow_lamp", new TallLampBlock(FabricBlockSettings.copy(Blocks.OAK_PLANKS).luminance(TallLampBlock.createLightLevelFromLitBlockState(12))), ModItemGroups.CLUTTER_BLOCKS);
    public static final Block TALL_LIME_LAMP = registerBlock("tall_lime_lamp", new TallLampBlock(FabricBlockSettings.copy(Blocks.OAK_PLANKS).luminance(TallLampBlock.createLightLevelFromLitBlockState(12))), ModItemGroups.CLUTTER_BLOCKS);
    public static final Block TALL_GREEN_LAMP = registerBlock("tall_green_lamp", new TallLampBlock(FabricBlockSettings.copy(Blocks.OAK_PLANKS).luminance(TallLampBlock.createLightLevelFromLitBlockState(12))), ModItemGroups.CLUTTER_BLOCKS);
    public static final Block TALL_CYAN_LAMP = registerBlock("tall_cyan_lamp", new TallLampBlock(FabricBlockSettings.copy(Blocks.OAK_PLANKS).luminance(TallLampBlock.createLightLevelFromLitBlockState(12))), ModItemGroups.CLUTTER_BLOCKS);
    public static final Block TALL_LIGHT_BLUE_LAMP = registerBlock("tall_light_blue_lamp", new TallLampBlock(FabricBlockSettings.copy(Blocks.OAK_PLANKS).luminance(TallLampBlock.createLightLevelFromLitBlockState(12))), ModItemGroups.CLUTTER_BLOCKS);
    public static final Block TALL_BLUE_LAMP = registerBlock("tall_blue_lamp", new TallLampBlock(FabricBlockSettings.copy(Blocks.OAK_PLANKS).luminance(TallLampBlock.createLightLevelFromLitBlockState(12))), ModItemGroups.CLUTTER_BLOCKS);
    public static final Block TALL_PURPLE_LAMP = registerBlock("tall_purple_lamp", new TallLampBlock(FabricBlockSettings.copy(Blocks.OAK_PLANKS).luminance(TallLampBlock.createLightLevelFromLitBlockState(12))), ModItemGroups.CLUTTER_BLOCKS);
    public static final Block TALL_MAGENTA_LAMP = registerBlock("tall_magenta_lamp", new TallLampBlock(FabricBlockSettings.copy(Blocks.OAK_PLANKS).luminance(TallLampBlock.createLightLevelFromLitBlockState(12))), ModItemGroups.CLUTTER_BLOCKS);
    public static final Block TALL_PINK_LAMP = registerBlock("tall_pink_lamp", new TallLampBlock(FabricBlockSettings.copy(Blocks.OAK_PLANKS).luminance(TallLampBlock.createLightLevelFromLitBlockState(12))), ModItemGroups.CLUTTER_BLOCKS);
    ...
    public static final Block GOLDEN_WALL_CANDLE = registerBlock("golden_wall_candle", new WallCandleBlock(FabricBlockSettings.copy(Blocks.GOLD_BLOCK).luminance(WallCandleBlock.createLightLevelFromLitBlockState(8))), ModItemGroups.CLUTTER_BLOCKS);
    public static final Block WHITE_GOLDEN_WALL_CANDLE = registerBlock("white_golden_wall_candle", new WallCandleBlock(FabricBlockSettings.copy(Blocks.GOLD_BLOCK).luminance(WallCandleBlock.createLightLevelFromLitBlockState(8))), ModItemGroups.CLUTTER_BLOCKS);
    public static final Block LIGHT_GRAY_GOLDEN_WALL_CANDLE = registerBlock("light_gray_golden_wall_candle", new WallCandleBlock(FabricBlockSettings.copy(Blocks.GOLD_BLOCK).luminance(WallCandleBlock.createLightLevelFromLitBlockState(8))), ModItemGroups.CLUTTER_BLOCKS);
    public static final Block GRAY_GOLDEN_WALL_CANDLE = registerBlock("gray_golden_wall_candle", new WallCandleBlock(FabricBlockSettings.copy(Blocks.GOLD_BLOCK).luminance(WallCandleBlock.createLightLevelFromLitBlockState(8))), ModItemGroups.CLUTTER_BLOCKS);
    public static final Block BLACK_GOLDEN_WALL_CANDLE = registerBlock("black_golden_wall_candle", new WallCandleBlock(FabricBlockSettings.copy(Blocks.GOLD_BLOCK).luminance(WallCandleBlock.createLightLevelFromLitBlockState(8))), ModItemGroups.CLUTTER_BLOCKS);
    public static final Block BROWN_GOLDEN_WALL_CANDLE = registerBlock("brown_golden_wall_candle", new WallCandleBlock(FabricBlockSettings.copy(Blocks.GOLD_BLOCK).luminance(WallCandleBlock.createLightLevelFromLitBlockState(8))), ModItemGroups.CLUTTER_BLOCKS);
    public static final Block RED_GOLDEN_WALL_CANDLE = registerBlock("red_golden_wall_candle", new WallCandleBlock(FabricBlockSettings.copy(Blocks.GOLD_BLOCK).luminance(WallCandleBlock.createLightLevelFromLitBlockState(8))), ModItemGroups.CLUTTER_BLOCKS);
    public static final Block ORANGE_GOLDEN_WALL_CANDLE = registerBlock("orange_golden_wall_candle", new WallCandleBlock(FabricBlockSettings.copy(Blocks.GOLD_BLOCK).luminance(WallCandleBlock.createLightLevelFromLitBlockState(8))), ModItemGroups.CLUTTER_BLOCKS);
    public static final Block YELLOW_GOLDEN_WALL_CANDLE = registerBlock("yellow_golden_wall_candle", new WallCandleBlock(FabricBlockSettings.copy(Blocks.GOLD_BLOCK).luminance(WallCandleBlock.createLightLevelFromLitBlockState(8))), ModItemGroups.CLUTTER_BLOCKS);
    public static final Block LIME_GOLDEN_WALL_CANDLE = registerBlock("lime_golden_wall_candle", new WallCandleBlock(FabricBlockSettings.copy(Blocks.GOLD_BLOCK).luminance(WallCandleBlock.createLightLevelFromLitBlockState(8))), ModItemGroups.CLUTTER_BLOCKS);
    public static final Block GREEN_GOLDEN_WALL_CANDLE = registerBlock("green_golden_wall_candle", new WallCandleBlock(FabricBlockSettings.copy(Blocks.GOLD_BLOCK).luminance(WallCandleBlock.createLightLevelFromLitBlockState(8))), ModItemGroups.CLUTTER_BLOCKS);
    public static final Block CYAN_GOLDEN_WALL_CANDLE = registerBlock("cyan_golden_wall_candle", new WallCandleBlock(FabricBlockSettings.copy(Blocks.GOLD_BLOCK).luminance(WallCandleBlock.createLightLevelFromLitBlockState(8))), ModItemGroups.CLUTTER_BLOCKS);
    public static final Block LIGHT_BLUE_GOLDEN_WALL_CANDLE = registerBlock("light_blue_golden_wall_candle", new WallCandleBlock(FabricBlockSettings.copy(Blocks.GOLD_BLOCK).luminance(WallCandleBlock.createLightLevelFromLitBlockState(8))), ModItemGroups.CLUTTER_BLOCKS);
    public static final Block BLUE_GOLDEN_WALL_CANDLE = registerBlock("blue_golden_wall_candle", new WallCandleBlock(FabricBlockSettings.copy(Blocks.GOLD_BLOCK).luminance(WallCandleBlock.createLightLevelFromLitBlockState(8))), ModItemGroups.CLUTTER_BLOCKS);
    public static final Block PURPLE_GOLDEN_WALL_CANDLE = registerBlock("purple_golden_wall_candle", new WallCandleBlock(FabricBlockSettings.copy(Blocks.GOLD_BLOCK).luminance(WallCandleBlock.createLightLevelFromLitBlockState(8))), ModItemGroups.CLUTTER_BLOCKS);
    public static final Block MAGENTA_GOLDEN_WALL_CANDLE = registerBlock("magenta_golden_wall_candle", new WallCandleBlock(FabricBlockSettings.copy(Blocks.GOLD_BLOCK).luminance(WallCandleBlock.createLightLevelFromLitBlockState(8))), ModItemGroups.CLUTTER_BLOCKS);
    public static final Block PINK_GOLDEN_WALL_CANDLE = registerBlock("pink_golden_wall_candle", new WallCandleBlock(FabricBlockSettings.copy(Blocks.GOLD_BLOCK).luminance(WallCandleBlock.createLightLevelFromLitBlockState(8))), ModItemGroups.CLUTTER_BLOCKS);

    public static final Block IRON_WALL_CANDLE = registerBlock("iron_wall_candle", new WallCandleBlock(FabricBlockSettings.copy(Blocks.IRON_BLOCK).luminance(WallCandleBlock.createLightLevelFromLitBlockState(8))), ModItemGroups.CLUTTER_BLOCKS);
    public static final Block WHITE_IRON_WALL_CANDLE = registerBlock("white_iron_wall_candle", new WallCandleBlock(FabricBlockSettings.copy(Blocks.IRON_BLOCK).luminance(WallCandleBlock.createLightLevelFromLitBlockState(8))), ModItemGroups.CLUTTER_BLOCKS);
    public static final Block LIGHT_GRAY_IRON_WALL_CANDLE = registerBlock("light_gray_iron_wall_candle", new WallCandleBlock(FabricBlockSettings.copy(Blocks.IRON_BLOCK).luminance(WallCandleBlock.createLightLevelFromLitBlockState(8))), ModItemGroups.CLUTTER_BLOCKS);
    public static final Block GRAY_IRON_WALL_CANDLE = registerBlock("gray_iron_wall_candle", new WallCandleBlock(FabricBlockSettings.copy(Blocks.IRON_BLOCK).luminance(WallCandleBlock.createLightLevelFromLitBlockState(8))), ModItemGroups.CLUTTER_BLOCKS);
    public static final Block BLACK_IRON_WALL_CANDLE = registerBlock("black_iron_wall_candle", new WallCandleBlock(FabricBlockSettings.copy(Blocks.IRON_BLOCK).luminance(WallCandleBlock.createLightLevelFromLitBlockState(8))), ModItemGroups.CLUTTER_BLOCKS);
    public static final Block BROWN_IRON_WALL_CANDLE = registerBlock("brown_iron_wall_candle", new WallCandleBlock(FabricBlockSettings.copy(Blocks.IRON_BLOCK).luminance(WallCandleBlock.createLightLevelFromLitBlockState(8))), ModItemGroups.CLUTTER_BLOCKS);
    public static final Block RED_IRON_WALL_CANDLE = registerBlock("red_iron_wall_candle", new WallCandleBlock(FabricBlockSettings.copy(Blocks.IRON_BLOCK).luminance(WallCandleBlock.createLightLevelFromLitBlockState(8))), ModItemGroups.CLUTTER_BLOCKS);
    public static final Block ORANGE_IRON_WALL_CANDLE = registerBlock("orange_iron_wall_candle", new WallCandleBlock(FabricBlockSettings.copy(Blocks.IRON_BLOCK).luminance(WallCandleBlock.createLightLevelFromLitBlockState(8))), ModItemGroups.CLUTTER_BLOCKS);
    public static final Block YELLOW_IRON_WALL_CANDLE = registerBlock("yellow_iron_wall_candle", new WallCandleBlock(FabricBlockSettings.copy(Blocks.IRON_BLOCK).luminance(WallCandleBlock.createLightLevelFromLitBlockState(8))), ModItemGroups.CLUTTER_BLOCKS);
    public static final Block LIME_IRON_WALL_CANDLE = registerBlock("lime_iron_wall_candle", new WallCandleBlock(FabricBlockSettings.copy(Blocks.IRON_BLOCK).luminance(WallCandleBlock.createLightLevelFromLitBlockState(8))), ModItemGroups.CLUTTER_BLOCKS);
    public static final Block GREEN_IRON_WALL_CANDLE = registerBlock("green_iron_wall_candle", new WallCandleBlock(FabricBlockSettings.copy(Blocks.IRON_BLOCK).luminance(WallCandleBlock.createLightLevelFromLitBlockState(8))), ModItemGroups.CLUTTER_BLOCKS);
    public static final Block CYAN_IRON_WALL_CANDLE = registerBlock("cyan_iron_wall_candle", new WallCandleBlock(FabricBlockSettings.copy(Blocks.IRON_BLOCK).luminance(WallCandleBlock.createLightLevelFromLitBlockState(8))), ModItemGroups.CLUTTER_BLOCKS);
    public static final Block LIGHT_BLUE_IRON_WALL_CANDLE = registerBlock("light_blue_iron_wall_candle", new WallCandleBlock(FabricBlockSettings.copy(Blocks.IRON_BLOCK).luminance(WallCandleBlock.createLightLevelFromLitBlockState(8))), ModItemGroups.CLUTTER_BLOCKS);
    public static final Block BLUE_IRON_WALL_CANDLE = registerBlock("blue_iron_wall_candle", new WallCandleBlock(FabricBlockSettings.copy(Blocks.IRON_BLOCK).luminance(WallCandleBlock.createLightLevelFromLitBlockState(8))), ModItemGroups.CLUTTER_BLOCKS);
    public static final Block PURPLE_IRON_WALL_CANDLE = registerBlock("purple_iron_wall_candle", new WallCandleBlock(FabricBlockSettings.copy(Blocks.IRON_BLOCK).luminance(WallCandleBlock.createLightLevelFromLitBlockState(8))), ModItemGroups.CLUTTER_BLOCKS);
    public static final Block MAGENTA_IRON_WALL_CANDLE = registerBlock("magenta_iron_wall_candle", new WallCandleBlock(FabricBlockSettings.copy(Blocks.IRON_BLOCK).luminance(WallCandleBlock.createLightLevelFromLitBlockState(8))), ModItemGroups.CLUTTER_BLOCKS);
    public static final Block PINK_IRON_WALL_CANDLE = registerBlock("pink_iron_wall_candle", new WallCandleBlock(FabricBlockSettings.copy(Blocks.IRON_BLOCK).luminance(WallCandleBlock.createLightLevelFromLitBlockState(8))), ModItemGroups.CLUTTER_BLOCKS);

    public static final Block SILVER_WALL_CANDLE = registerBlock("silver_wall_candle", new WallCandleBlock(FabricBlockSettings.copy(ModBlocks.SILVER_BLOCK).luminance(WallCandleBlock.createLightLevelFromLitBlockState(8))), ModItemGroups.CLUTTER_BLOCKS);
    public static final Block WHITE_SILVER_WALL_CANDLE = registerBlock("white_silver_wall_candle", new WallCandleBlock(FabricBlockSettings.copy(ModBlocks.SILVER_BLOCK).luminance(WallCandleBlock.createLightLevelFromLitBlockState(8))), ModItemGroups.CLUTTER_BLOCKS);
    public static final Block LIGHT_GRAY_SILVER_WALL_CANDLE = registerBlock("light_gray_silver_wall_candle", new WallCandleBlock(FabricBlockSettings.copy(ModBlocks.SILVER_BLOCK).luminance(WallCandleBlock.createLightLevelFromLitBlockState(8))), ModItemGroups.CLUTTER_BLOCKS);
    public static final Block GRAY_SILVER_WALL_CANDLE = registerBlock("gray_silver_wall_candle", new WallCandleBlock(FabricBlockSettings.copy(ModBlocks.SILVER_BLOCK).luminance(WallCandleBlock.createLightLevelFromLitBlockState(8))), ModItemGroups.CLUTTER_BLOCKS);
    public static final Block BLACK_SILVER_WALL_CANDLE = registerBlock("black_silver_wall_candle", new WallCandleBlock(FabricBlockSettings.copy(ModBlocks.SILVER_BLOCK).luminance(WallCandleBlock.createLightLevelFromLitBlockState(8))), ModItemGroups.CLUTTER_BLOCKS);
    public static final Block BROWN_SILVER_WALL_CANDLE = registerBlock("brown_silver_wall_candle", new WallCandleBlock(FabricBlockSettings.copy(ModBlocks.SILVER_BLOCK).luminance(WallCandleBlock.createLightLevelFromLitBlockState(8))), ModItemGroups.CLUTTER_BLOCKS);
    public static final Block RED_SILVER_WALL_CANDLE = registerBlock("red_silver_wall_candle", new WallCandleBlock(FabricBlockSettings.copy(ModBlocks.SILVER_BLOCK).luminance(WallCandleBlock.createLightLevelFromLitBlockState(8))), ModItemGroups.CLUTTER_BLOCKS);
    public static final Block ORANGE_SILVER_WALL_CANDLE = registerBlock("orange_silver_wall_candle", new WallCandleBlock(FabricBlockSettings.copy(ModBlocks.SILVER_BLOCK).luminance(WallCandleBlock.createLightLevelFromLitBlockState(8))), ModItemGroups.CLUTTER_BLOCKS);
    public static final Block YELLOW_SILVER_WALL_CANDLE = registerBlock("yellow_silver_wall_candle", new WallCandleBlock(FabricBlockSettings.copy(ModBlocks.SILVER_BLOCK).luminance(WallCandleBlock.createLightLevelFromLitBlockState(8))), ModItemGroups.CLUTTER_BLOCKS);
    public static final Block LIME_SILVER_WALL_CANDLE = registerBlock("lime_silver_wall_candle", new WallCandleBlock(FabricBlockSettings.copy(ModBlocks.SILVER_BLOCK).luminance(WallCandleBlock.createLightLevelFromLitBlockState(8))), ModItemGroups.CLUTTER_BLOCKS);
    public static final Block GREEN_SILVER_WALL_CANDLE = registerBlock("green_silver_wall_candle", new WallCandleBlock(FabricBlockSettings.copy(ModBlocks.SILVER_BLOCK).luminance(WallCandleBlock.createLightLevelFromLitBlockState(8))), ModItemGroups.CLUTTER_BLOCKS);
    public static final Block CYAN_SILVER_WALL_CANDLE = registerBlock("cyan_silver_wall_candle", new WallCandleBlock(FabricBlockSettings.copy(ModBlocks.SILVER_BLOCK).luminance(WallCandleBlock.createLightLevelFromLitBlockState(8))), ModItemGroups.CLUTTER_BLOCKS);
    public static final Block LIGHT_BLUE_SILVER_WALL_CANDLE = registerBlock("light_blue_silver_wall_candle", new WallCandleBlock(FabricBlockSettings.copy(ModBlocks.SILVER_BLOCK).luminance(WallCandleBlock.createLightLevelFromLitBlockState(8))), ModItemGroups.CLUTTER_BLOCKS);
    public static final Block BLUE_SILVER_WALL_CANDLE = registerBlock("blue_silver_wall_candle", new WallCandleBlock(FabricBlockSettings.copy(ModBlocks.SILVER_BLOCK).luminance(WallCandleBlock.createLightLevelFromLitBlockState(8))), ModItemGroups.CLUTTER_BLOCKS);
    public static final Block PURPLE_SILVER_WALL_CANDLE = registerBlock("purple_silver_wall_candle", new WallCandleBlock(FabricBlockSettings.copy(ModBlocks.SILVER_BLOCK).luminance(WallCandleBlock.createLightLevelFromLitBlockState(8))), ModItemGroups.CLUTTER_BLOCKS);
    public static final Block MAGENTA_SILVER_WALL_CANDLE = registerBlock("magenta_silver_wall_candle", new WallCandleBlock(FabricBlockSettings.copy(ModBlocks.SILVER_BLOCK).luminance(WallCandleBlock.createLightLevelFromLitBlockState(8))), ModItemGroups.CLUTTER_BLOCKS);
    public static final Block PINK_SILVER_WALL_CANDLE = registerBlock("pink_silver_wall_candle", new WallCandleBlock(FabricBlockSettings.copy(ModBlocks.SILVER_BLOCK).luminance(WallCandleBlock.createLightLevelFromLitBlockState(8))), ModItemGroups.CLUTTER_BLOCKS);

    public static final Block COPPER_WALL_CANDLE = registerBlock("copper_wall_candle", new OxidizableWallCandleBlock(Oxidizable.OxidationLevel.UNAFFECTED, FabricBlockSettings.copy(Blocks.COPPER_BLOCK).luminance(WallCandleBlock.createLightLevelFromLitBlockState(8))), ModItemGroups.CLUTTER_BLOCKS);
    public static final Block WHITE_COPPER_WALL_CANDLE = registerBlock("white_copper_wall_candle", new OxidizableWallCandleBlock(Oxidizable.OxidationLevel.UNAFFECTED,FabricBlockSettings.copy(Blocks.COPPER_BLOCK).luminance(WallCandleBlock.createLightLevelFromLitBlockState(8))), ModItemGroups.CLUTTER_BLOCKS);
    public static final Block LIGHT_GRAY_COPPER_WALL_CANDLE = registerBlock("light_gray_copper_wall_candle", new OxidizableWallCandleBlock(Oxidizable.OxidationLevel.UNAFFECTED,FabricBlockSettings.copy(Blocks.COPPER_BLOCK).luminance(WallCandleBlock.createLightLevelFromLitBlockState(8))), ModItemGroups.CLUTTER_BLOCKS);
    public static final Block GRAY_COPPER_WALL_CANDLE = registerBlock("gray_copper_wall_candle", new OxidizableWallCandleBlock(Oxidizable.OxidationLevel.UNAFFECTED,FabricBlockSettings.copy(Blocks.COPPER_BLOCK).luminance(WallCandleBlock.createLightLevelFromLitBlockState(8))), ModItemGroups.CLUTTER_BLOCKS);
    public static final Block BLACK_COPPER_WALL_CANDLE = registerBlock("black_copper_wall_candle", new OxidizableWallCandleBlock(Oxidizable.OxidationLevel.UNAFFECTED,FabricBlockSettings.copy(Blocks.COPPER_BLOCK).luminance(WallCandleBlock.createLightLevelFromLitBlockState(8))), ModItemGroups.CLUTTER_BLOCKS);
    public static final Block BROWN_COPPER_WALL_CANDLE = registerBlock("brown_copper_wall_candle", new OxidizableWallCandleBlock(Oxidizable.OxidationLevel.UNAFFECTED,FabricBlockSettings.copy(Blocks.COPPER_BLOCK).luminance(WallCandleBlock.createLightLevelFromLitBlockState(8))), ModItemGroups.CLUTTER_BLOCKS);
    public static final Block RED_COPPER_WALL_CANDLE = registerBlock("red_copper_wall_candle", new OxidizableWallCandleBlock(Oxidizable.OxidationLevel.UNAFFECTED,FabricBlockSettings.copy(Blocks.COPPER_BLOCK).luminance(WallCandleBlock.createLightLevelFromLitBlockState(8))), ModItemGroups.CLUTTER_BLOCKS);
    public static final Block ORANGE_COPPER_WALL_CANDLE = registerBlock("orange_copper_wall_candle", new OxidizableWallCandleBlock(Oxidizable.OxidationLevel.UNAFFECTED,FabricBlockSettings.copy(Blocks.COPPER_BLOCK).luminance(WallCandleBlock.createLightLevelFromLitBlockState(8))), ModItemGroups.CLUTTER_BLOCKS);
    public static final Block YELLOW_COPPER_WALL_CANDLE = registerBlock("yellow_copper_wall_candle", new OxidizableWallCandleBlock(Oxidizable.OxidationLevel.UNAFFECTED,FabricBlockSettings.copy(Blocks.COPPER_BLOCK).luminance(WallCandleBlock.createLightLevelFromLitBlockState(8))), ModItemGroups.CLUTTER_BLOCKS);
    public static final Block LIME_COPPER_WALL_CANDLE = registerBlock("lime_copper_wall_candle", new OxidizableWallCandleBlock(Oxidizable.OxidationLevel.UNAFFECTED,FabricBlockSettings.copy(Blocks.COPPER_BLOCK).luminance(WallCandleBlock.createLightLevelFromLitBlockState(8))), ModItemGroups.CLUTTER_BLOCKS);
    public static final Block GREEN_COPPER_WALL_CANDLE = registerBlock("green_copper_wall_candle", new OxidizableWallCandleBlock(Oxidizable.OxidationLevel.UNAFFECTED,FabricBlockSettings.copy(Blocks.COPPER_BLOCK).luminance(WallCandleBlock.createLightLevelFromLitBlockState(8))), ModItemGroups.CLUTTER_BLOCKS);
    public static final Block CYAN_COPPER_WALL_CANDLE = registerBlock("cyan_copper_wall_candle", new OxidizableWallCandleBlock(Oxidizable.OxidationLevel.UNAFFECTED,FabricBlockSettings.copy(Blocks.COPPER_BLOCK).luminance(WallCandleBlock.createLightLevelFromLitBlockState(8))), ModItemGroups.CLUTTER_BLOCKS);
    public static final Block LIGHT_BLUE_COPPER_WALL_CANDLE = registerBlock("light_blue_copper_wall_candle", new OxidizableWallCandleBlock(Oxidizable.OxidationLevel.UNAFFECTED,FabricBlockSettings.copy(Blocks.COPPER_BLOCK).luminance(WallCandleBlock.createLightLevelFromLitBlockState(8))), ModItemGroups.CLUTTER_BLOCKS);
    public static final Block BLUE_COPPER_WALL_CANDLE = registerBlock("blue_copper_wall_candle", new OxidizableWallCandleBlock(Oxidizable.OxidationLevel.UNAFFECTED,FabricBlockSettings.copy(Blocks.COPPER_BLOCK).luminance(WallCandleBlock.createLightLevelFromLitBlockState(8))), ModItemGroups.CLUTTER_BLOCKS);
    public static final Block PURPLE_COPPER_WALL_CANDLE = registerBlock("purple_copper_wall_candle", new OxidizableWallCandleBlock(Oxidizable.OxidationLevel.UNAFFECTED,FabricBlockSettings.copy(Blocks.COPPER_BLOCK).luminance(WallCandleBlock.createLightLevelFromLitBlockState(8))), ModItemGroups.CLUTTER_BLOCKS);
    public static final Block MAGENTA_COPPER_WALL_CANDLE = registerBlock("magenta_copper_wall_candle", new OxidizableWallCandleBlock(Oxidizable.OxidationLevel.UNAFFECTED,FabricBlockSettings.copy(Blocks.COPPER_BLOCK).luminance(WallCandleBlock.createLightLevelFromLitBlockState(8))), ModItemGroups.CLUTTER_BLOCKS);
    public static final Block PINK_COPPER_WALL_CANDLE = registerBlock("pink_copper_wall_candle", new OxidizableWallCandleBlock(Oxidizable.OxidationLevel.UNAFFECTED,FabricBlockSettings.copy(Blocks.COPPER_BLOCK).luminance(WallCandleBlock.createLightLevelFromLitBlockState(8))), ModItemGroups.CLUTTER_BLOCKS);

    public static final Block EXPOSED_COPPER_WALL_CANDLE = registerBlock("exposed_copper_wall_candle", new OxidizableWallCandleBlock(Oxidizable.OxidationLevel.EXPOSED, FabricBlockSettings.copy(Blocks.EXPOSED_COPPER).luminance(WallCandleBlock.createLightLevelFromLitBlockState(8))), ModItemGroups.CLUTTER_BLOCKS);
    public static final Block EXPOSED_WHITE_COPPER_WALL_CANDLE = registerBlock("exposed_white_copper_wall_candle", new OxidizableWallCandleBlock(Oxidizable.OxidationLevel.EXPOSED,FabricBlockSettings.copy(Blocks.EXPOSED_COPPER).luminance(WallCandleBlock.createLightLevelFromLitBlockState(8))), ModItemGroups.CLUTTER_BLOCKS);
    ...
    public static final Block WEATHERED_COPPER_WALL_CANDLE = registerBlock("weathered_copper_wall_candle", new OxidizableWallCandleBlock(Oxidizable.OxidationLevel.WEATHERED, FabricBlockSettings.copy(Blocks.WEATHERED_COPPER).luminance(WallCandleBlock.createLightLevelFromLitBlockState(8))), ModItemGroups.CLUTTER_BLOCKS);
    public static final Block WEATHERED_WHITE_COPPER_WALL_CANDLE = registerBlock("weathered_white_copper_wall_candle", new OxidizableWallCandleBlock(Oxidizable.OxidationLevel.WEATHERED,FabricBlockSettings.copy(Blocks.WEATHERED_COPPER).luminance(WallCandleBlock.createLightLevelFromLitBlockState(8))), ModItemGroups.CLUTTER_BLOCKS);
    public static final Block WEATHERED_LIGHT_GRAY_COPPER_WALL_CANDLE = registerBlock("weathered_light_gray_copper_wall_candle", new OxidizableWallCandleBlock(Oxidizable.OxidationLevel.WEATHERED,FabricBlockSettings.copy(Blocks.WEATHERED_COPPER).luminance(WallCandleBlock.createLightLevelFromLitBlockState(8))), ModItemGroups.CLUTTER_BLOCKS);
    public static final Block WEATHERED_GRAY_COPPER_WALL_CANDLE = registerBlock("weathered_gray_copper_wall_candle", new OxidizableWallCandleBlock(Oxidizable.OxidationLevel.WEATHERED,FabricBlockSettings.copy(Blocks.WEATHERED_COPPER).luminance(WallCandleBlock.createLightLevelFromLitBlockState(8))), ModItemGroups.CLUTTER_BLOCKS);
    public static final Block WEATHERED_BLACK_COPPER_WALL_CANDLE = registerBlock("weathered_black_copper_wall_candle", new OxidizableWallCandleBlock(Oxidizable.OxidationLevel.WEATHERED,FabricBlockSettings.copy(Blocks.WEATHERED_COPPER).luminance(WallCandleBlock.createLightLevelFromLitBlockState(8))), ModItemGroups.CLUTTER_BLOCKS);
    public static final Block WEATHERED_BROWN_COPPER_WALL_CANDLE = registerBlock("weathered_brown_copper_wall_candle", new OxidizableWallCandleBlock(Oxidizable.OxidationLevel.WEATHERED,FabricBlockSettings.copy(Blocks.WEATHERED_COPPER).luminance(WallCandleBlock.createLightLevelFromLitBlockState(8))), ModItemGroups.CLUTTER_BLOCKS);
    public static final Block WEATHERED_RED_COPPER_WALL_CANDLE = registerBlock("weathered_red_copper_wall_candle", new OxidizableWallCandleBlock(Oxidizable.OxidationLevel.WEATHERED,FabricBlockSettings.copy(Blocks.WEATHERED_COPPER).luminance(WallCandleBlock.createLightLevelFromLitBlockState(8))), ModItemGroups.CLUTTER_BLOCKS);
    public static final Block WEATHERED_ORANGE_COPPER_WALL_CANDLE = registerBlock("weathered_orange_copper_wall_candle", new OxidizableWallCandleBlock(Oxidizable.OxidationLevel.WEATHERED,FabricBlockSettings.copy(Blocks.WEATHERED_COPPER).luminance(WallCandleBlock.createLightLevelFromLitBlockState(8))), ModItemGroups.CLUTTER_BLOCKS);
    public static final Block WEATHERED_YELLOW_COPPER_WALL_CANDLE = registerBlock("weathered_yellow_copper_wall_candle", new OxidizableWallCandleBlock(Oxidizable.OxidationLevel.WEATHERED,FabricBlockSettings.copy(Blocks.WEATHERED_COPPER).luminance(WallCandleBlock.createLightLevelFromLitBlockState(8))), ModItemGroups.CLUTTER_BLOCKS);
    public static final Block WEATHERED_LIME_COPPER_WALL_CANDLE = registerBlock("weathered_lime_copper_wall_candle", new OxidizableWallCandleBlock(Oxidizable.OxidationLevel.WEATHERED,FabricBlockSettings.copy(Blocks.WEATHERED_COPPER).luminance(WallCandleBlock.createLightLevelFromLitBlockState(8))), ModItemGroups.CLUTTER_BLOCKS);
    public static final Block WEATHERED_GREEN_COPPER_WALL_CANDLE = registerBlock("weathered_green_copper_wall_candle", new OxidizableWallCandleBlock(Oxidizable.OxidationLevel.WEATHERED,FabricBlockSettings.copy(Blocks.WEATHERED_COPPER).luminance(WallCandleBlock.createLightLevelFromLitBlockState(8))), ModItemGroups.CLUTTER_BLOCKS);
    public static final Block WEATHERED_CYAN_COPPER_WALL_CANDLE = registerBlock("weathered_cyan_copper_wall_candle", new OxidizableWallCandleBlock(Oxidizable.OxidationLevel.WEATHERED,FabricBlockSettings.copy(Blocks.WEATHERED_COPPER).luminance(WallCandleBlock.createLightLevelFromLitBlockState(8))), ModItemGroups.CLUTTER_BLOCKS);
    ...
    public static final Block WEATHERED_PURPLE_COPPER_WALL_CANDLE = registerBlock("weathered_purple_copper_wall_candle", new OxidizableWallCandleBlock(Oxidizable.OxidationLevel.WEATHERED,FabricBlockSettings.copy(Blocks.WEATHERED_COPPER).luminance(WallCandleBlock.createLightLevelFromLitBlockState(8))), ModItemGroups.CLUTTER_BLOCKS);
    public static final Block WEATHERED_MAGENTA_COPPER_WALL_CANDLE = registerBlock("weathered_magenta_copper_wall_candle", new OxidizableWallCandleBlock(Oxidizable.OxidationLevel.WEATHERED,FabricBlockSettings.copy(Blocks.WEATHERED_COPPER).luminance(WallCandleBlock.createLightLevelFromLitBlockState(8))), ModItemGroups.CLUTTER_BLOCKS);
    public static final Block WEATHERED_PINK_COPPER_WALL_CANDLE = registerBlock("weathered_pink_copper_wall_candle", new OxidizableWallCandleBlock(Oxidizable.OxidationLevel.WEATHERED,FabricBlockSettings.copy(Blocks.WEATHERED_COPPER).luminance(WallCandleBlock.createLightLevelFromLitBlockState(8))), ModItemGroups.CLUTTER_BLOCKS);

    public static final Block OXIDIZED_COPPER_WALL_CANDLE = registerBlock("oxidized_copper_wall_candle", new OxidizableWallCandleBlock(Oxidizable.OxidationLevel.OXIDIZED, FabricBlockSettings.copy(Blocks.WEATHERED_COPPER).luminance(WallCandleBlock.createLightLevelFromLitBlockState(8))), ModItemGroups.CLUTTER_BLOCKS);
    public static final Block OXIDIZED_WHITE_COPPER_WALL_CANDLE = registerBlock("oxidized_white_copper_wall_candle", new OxidizableWallCandleBlock(Oxidizable.OxidationLevel.OXIDIZED,FabricBlockSettings.copy(Blocks.WEATHERED_COPPER).luminance(WallCandleBlock.createLightLevelFromLitBlockState(8))), ModItemGroups.CLUTTER_BLOCKS);
    ...
    public static final Block WAXED_COPPER_WALL_CANDLE = registerBlock("waxed_copper_wall_candle", new WallCandleBlock(FabricBlockSettings.copy(Blocks.COPPER_BLOCK).luminance(WallCandleBlock.createLightLevelFromLitBlockState(8))), ModItemGroups.CLUTTER_BLOCKS);
    public static final Block WAXED_WHITE_COPPER_WALL_CANDLE = registerBlock("waxed_white_copper_wall_candle", new WallCandleBlock(FabricBlockSettings.copy(Blocks.COPPER_BLOCK).luminance(WallCandleBlock.createLightLevelFromLitBlockState(8))), ModItemGroups.CLUTTER_BLOCKS);
    public static final Block WAXED_LIGHT_GRAY_COPPER_WALL_CANDLE = registerBlock("waxed_light_gray_copper_wall_candle", new WallCandleBlock(FabricBlockSettings.copy(Blocks.COPPER_BLOCK).luminance(WallCandleBlock.createLightLevelFromLitBlockState(8))), ModItemGroups.CLUTTER_BLOCKS);
    public static final Block WAXED_GRAY_COPPER_WALL_CANDLE = registerBlock("waxed_gray_copper_wall_candle", new WallCandleBlock(FabricBlockSettings.copy(Blocks.COPPER_BLOCK).luminance(WallCandleBlock.createLightLevelFromLitBlockState(8))), ModItemGroups.CLUTTER_BLOCKS);
    public static final Block WAXED_BLACK_COPPER_WALL_CANDLE = registerBlock("waxed_black_copper_wall_candle", new WallCandleBlock(FabricBlockSettings.copy(Blocks.COPPER_BLOCK).luminance(WallCandleBlock.createLightLevelFromLitBlockState(8))), ModItemGroups.CLUTTER_BLOCKS);
    public static final Block WAXED_BROWN_COPPER_WALL_CANDLE = registerBlock("waxed_brown_copper_wall_candle", new WallCandleBlock(FabricBlockSettings.copy(Blocks.COPPER_BLOCK).luminance(WallCandleBlock.createLightLevelFromLitBlockState(8))), ModItemGroups.CLUTTER_BLOCKS);
    public static final Block WAXED_RED_COPPER_WALL_CANDLE = registerBlock("waxed_red_copper_wall_candle", new WallCandleBlock(FabricBlockSettings.copy(Blocks.COPPER_BLOCK).luminance(WallCandleBlock.createLightLevelFromLitBlockState(8))), ModItemGroups.CLUTTER_BLOCKS);
    public static final Block WAXED_ORANGE_COPPER_WALL_CANDLE = registerBlock("waxed_orange_copper_wall_candle", new WallCandleBlock(FabricBlockSettings.copy(Blocks.COPPER_BLOCK).luminance(WallCandleBlock.createLightLevelFromLitBlockState(8))), ModItemGroups.CLUTTER_BLOCKS);
    public static final Block WAXED_YELLOW_COPPER_WALL_CANDLE = registerBlock("waxed_yellow_copper_wall_candle", new WallCandleBlock(FabricBlockSettings.copy(Blocks.COPPER_BLOCK).luminance(WallCandleBlock.createLightLevelFromLitBlockState(8))), ModItemGroups.CLUTTER_BLOCKS);
    public static final Block WAXED_LIME_COPPER_WALL_CANDLE = registerBlock("waxed_lime_copper_wall_candle", new WallCandleBlock(FabricBlockSettings.copy(Blocks.COPPER_BLOCK).luminance(WallCandleBlock.createLightLevelFromLitBlockState(8))), ModItemGroups.CLUTTER_BLOCKS);
    public static final Block WAXED_GREEN_COPPER_WALL_CANDLE = registerBlock("waxed_green_copper_wall_candle", new WallCandleBlock(FabricBlockSettings.copy(Blocks.COPPER_BLOCK).luminance(WallCandleBlock.createLightLevelFromLitBlockState(8))), ModItemGroups.CLUTTER_BLOCKS);
    public static final Block WAXED_CYAN_COPPER_WALL_CANDLE = registerBlock("waxed_cyan_copper_wall_candle", new WallCandleBlock(FabricBlockSettings.copy(Blocks.COPPER_BLOCK).luminance(WallCandleBlock.createLightLevelFromLitBlockState(8))), ModItemGroups.CLUTTER_BLOCKS);
    public static final Block WAXED_LIGHT_BLUE_COPPER_WALL_CANDLE = registerBlock("waxed_light_blue_copper_wall_candle", new WallCandleBlock(FabricBlockSettings.copy(Blocks.COPPER_BLOCK).luminance(WallCandleBlock.createLightLevelFromLitBlockState(8))), ModItemGroups.CLUTTER_BLOCKS);
    public static final Block WAXED_BLUE_COPPER_WALL_CANDLE = registerBlock("waxed_blue_copper_wall_candle", new WallCandleBlock(FabricBlockSettings.copy(Blocks.COPPER_BLOCK).luminance(WallCandleBlock.createLightLevelFromLitBlockState(8))), ModItemGroups.CLUTTER_BLOCKS);
    public static final Block WAXED_PURPLE_COPPER_WALL_CANDLE = registerBlock("waxed_purple_copper_wall_candle", new WallCandleBlock(FabricBlockSettings.copy(Blocks.COPPER_BLOCK).luminance(WallCandleBlock.createLightLevelFromLitBlockState(8))), ModItemGroups.CLUTTER_BLOCKS);
    public static final Block WAXED_MAGENTA_COPPER_WALL_CANDLE = registerBlock("waxed_magenta_copper_wall_candle", new WallCandleBlock(FabricBlockSettings.copy(Blocks.COPPER_BLOCK).luminance(WallCandleBlock.createLightLevelFromLitBlockState(8))), ModItemGroups.CLUTTER_BLOCKS);
    public static final Block WAXED_PINK_COPPER_WALL_CANDLE = registerBlock("waxed_pink_copper_wall_candle", new WallCandleBlock(FabricBlockSettings.copy(Blocks.COPPER_BLOCK).luminance(WallCandleBlock.createLightLevelFromLitBlockState(8))), ModItemGroups.CLUTTER_BLOCKS);

    public static final Block WAXED_EXPOSED_COPPER_WALL_CANDLE = registerBlock("waxed_exposed_copper_wall_candle", new WallCandleBlock(FabricBlockSettings.copy(Blocks.COPPER_BLOCK).luminance(WallCandleBlock.createLightLevelFromLitBlockState(8))), ModItemGroups.CLUTTER_BLOCKS);
    public static final Block WAXED_EXPOSED_WHITE_COPPER_WALL_CANDLE = registerBlock("waxed_exposed_white_copper_wall_candle", new WallCandleBlock(FabricBlockSettings.copy(Blocks.COPPER_BLOCK).luminance(WallCandleBlock.createLightLevelFromLitBlockState(8))), ModItemGroups.CLUTTER_BLOCKS);
    public static final Block WAXED_EXPOSED_LIGHT_GRAY_COPPER_WALL_CANDLE = registerBlock("waxed_exposed_light_gray_copper_wall_candle", new WallCandleBlock(FabricBlockSettings.copy(Blocks.COPPER_BLOCK).luminance(WallCandleBlock.createLightLevelFromLitBlockState(8))), ModItemGroups.CLUTTER_BLOCKS);
    public static final Block WAXED_EXPOSED_GRAY_COPPER_WALL_CANDLE = registerBlock("waxed_exposed_gray_copper_wall_candle", new WallCandleBlock(FabricBlockSettings.copy(Blocks.COPPER_BLOCK).luminance(WallCandleBlock.createLightLevelFromLitBlockState(8))), ModItemGroups.CLUTTER_BLOCKS);
    public static final Block WAXED_EXPOSED_BLACK_COPPER_WALL_CANDLE = registerBlock("waxed_exposed_black_copper_wall_candle", new WallCandleBlock(FabricBlockSettings.copy(Blocks.COPPER_BLOCK).luminance(WallCandleBlock.createLightLevelFromLitBlockState(8))), ModItemGroups.CLUTTER_BLOCKS);
    public static final Block WAXED_EXPOSED_BROWN_COPPER_WALL_CANDLE = registerBlock("waxed_exposed_brown_copper_wall_candle", new WallCandleBlock(FabricBlockSettings.copy(Blocks.COPPER_BLOCK).luminance(WallCandleBlock.createLightLevelFromLitBlockState(8))), ModItemGroups.CLUTTER_BLOCKS);
    public static final Block WAXED_EXPOSED_RED_COPPER_WALL_CANDLE = registerBlock("waxed_exposed_red_copper_wall_candle", new WallCandleBlock(FabricBlockSettings.copy(Blocks.COPPER_BLOCK).luminance(WallCandleBlock.createLightLevelFromLitBlockState(8))), ModItemGroups.CLUTTER_BLOCKS);
    public static final Block WAXED_EXPOSED_ORANGE_COPPER_WALL_CANDLE = registerBlock("waxed_exposed_orange_copper_wall_candle", new WallCandleBlock(FabricBlockSettings.copy(Blocks.COPPER_BLOCK).luminance(WallCandleBlock.createLightLevelFromLitBlockState(8))), ModItemGroups.CLUTTER_BLOCKS);
    public static final Block WAXED_EXPOSED_YELLOW_COPPER_WALL_CANDLE = registerBlock("waxed_exposed_yellow_copper_wall_candle", new WallCandleBlock(FabricBlockSettings.copy(Blocks.COPPER_BLOCK).luminance(WallCandleBlock.createLightLevelFromLitBlockState(8))), ModItemGroups.CLUTTER_BLOCKS);
    public static final Block WAXED_EXPOSED_LIME_COPPER_WALL_CANDLE = registerBlock("waxed_exposed_lime_copper_wall_candle", new WallCandleBlock(FabricBlockSettings.copy(Blocks.COPPER_BLOCK).luminance(WallCandleBlock.createLightLevelFromLitBlockState(8))), ModItemGroups.CLUTTER_BLOCKS);
    public static final Block WAXED_EXPOSED_GREEN_COPPER_WALL_CANDLE = registerBlock("waxed_exposed_green_copper_wall_candle", new WallCandleBlock(FabricBlockSettings.copy(Blocks.COPPER_BLOCK).luminance(WallCandleBlock.createLightLevelFromLitBlockState(8))), ModItemGroups.CLUTTER_BLOCKS);
    public static final Block WAXED_EXPOSED_CYAN_COPPER_WALL_CANDLE = registerBlock("waxed_exposed_cyan_copper_wall_candle", new WallCandleBlock(FabricBlockSettings.copy(Blocks.COPPER_BLOCK).luminance(WallCandleBlock.createLightLevelFromLitBlockState(8))), ModItemGroups.CLUTTER_BLOCKS);
    public static final Block WAXED_EXPOSED_LIGHT_BLUE_COPPER_WALL_CANDLE = registerBlock("waxed_exposed_light_blue_copper_wall_candle", new WallCandleBlock(FabricBlockSettings.copy(Blocks.COPPER_BLOCK).luminance(WallCandleBlock.createLightLevelFromLitBlockState(8))), ModItemGroups.CLUTTER_BLOCKS);
    public static final Block WAXED_EXPOSED_BLUE_COPPER_WALL_CANDLE = registerBlock("waxed_exposed_blue_copper_wall_candle", new WallCandleBlock(FabricBlockSettings.copy(Blocks.COPPER_BLOCK).luminance(WallCandleBlock.createLightLevelFromLitBlockState(8))), ModItemGroups.CLUTTER_BLOCKS);
    public static final Block WAXED_EXPOSED_PURPLE_COPPER_WALL_CANDLE = registerBlock("waxed_exposed_purple_copper_wall_candle", new WallCandleBlock(FabricBlockSettings.copy(Blocks.COPPER_BLOCK).luminance(WallCandleBlock.createLightLevelFromLitBlockState(8))), ModItemGroups.CLUTTER_BLOCKS);
    public static final Block WAXED_EXPOSED_MAGENTA_COPPER_WALL_CANDLE = registerBlock("waxed_exposed_magenta_copper_wall_candle", new WallCandleBlock(FabricBlockSettings.copy(Blocks.COPPER_BLOCK).luminance(WallCandleBlock.createLightLevelFromLitBlockState(8))), ModItemGroups.CLUTTER_BLOCKS);
    public static final Block WAXED_EXPOSED_PINK_COPPER_WALL_CANDLE = registerBlock("waxed_exposed_pink_copper_wall_candle", new WallCandleBlock(FabricBlockSettings.copy(Blocks.COPPER_BLOCK).luminance(WallCandleBlock.createLightLevelFromLitBlockState(8))), ModItemGroups.CLUTTER_BLOCKS);

    public static final Block WAXED_WEATHERED_COPPER_WALL_CANDLE = registerBlock("waxed_weathered_copper_wall_candle", new WallCandleBlock(FabricBlockSettings.copy(Blocks.COPPER_BLOCK).luminance(WallCandleBlock.createLightLevelFromLitBlockState(8))), ModItemGroups.CLUTTER_BLOCKS);
    public static final Block WAXED_WEATHERED_WHITE_COPPER_WALL_CANDLE = registerBlock("waxed_weathered_white_copper_wall_candle", new WallCandleBlock(FabricBlockSettings.copy(Blocks.COPPER_BLOCK).luminance(WallCandleBlock.createLightLevelFromLitBlockState(8))), ModItemGroups.CLUTTER_BLOCKS);
    public static final Block WAXED_WEATHERED_LIGHT_GRAY_COPPER_WALL_CANDLE = registerBlock("waxed_weathered_light_gray_copper_wall_candle", new WallCandleBlock(FabricBlockSettings.copy(Blocks.COPPER_BLOCK).luminance(WallCandleBlock.createLightLevelFromLitBlockState(8))), ModItemGroups.CLUTTER_BLOCKS);
    public static final Block WAXED_WEATHERED_GRAY_COPPER_WALL_CANDLE = registerBlock("waxed_weathered_gray_copper_wall_candle", new WallCandleBlock(FabricBlockSettings.copy(Blocks.COPPER_BLOCK).luminance(WallCandleBlock.createLightLevelFromLitBlockState(8))), ModItemGroups.CLUTTER_BLOCKS);
    public static final Block WAXED_WEATHERED_BLACK_COPPER_WALL_CANDLE = registerBlock("waxed_weathered_black_copper_wall_candle", new WallCandleBlock(FabricBlockSettings.copy(Blocks.COPPER_BLOCK).luminance(WallCandleBlock.createLightLevelFromLitBlockState(8))), ModItemGroups.CLUTTER_BLOCKS);
    public static final Block WAXED_WEATHERED_BROWN_COPPER_WALL_CANDLE = registerBlock("waxed_weathered_brown_copper_wall_candle", new WallCandleBlock(FabricBlockSettings.copy(Blocks.COPPER_BLOCK).luminance(WallCandleBlock.createLightLevelFromLitBlockState(8))), ModItemGroups.CLUTTER_BLOCKS);
    public static final Block WAXED_WEATHERED_RED_COPPER_WALL_CANDLE = registerBlock("waxed_weathered_red_copper_wall_candle", new WallCandleBlock(FabricBlockSettings.copy(Blocks.COPPER_BLOCK).luminance(WallCandleBlock.createLightLevelFromLitBlockState(8))), ModItemGroups.CLUTTER_BLOCKS);
    public static final Block WAXED_WEATHERED_ORANGE_COPPER_WALL_CANDLE = registerBlock("waxed_weathered_orange_copper_wall_candle", new WallCandleBlock(FabricBlockSettings.copy(Blocks.COPPER_BLOCK).luminance(WallCandleBlock.createLightLevelFromLitBlockState(8))), ModItemGroups.CLUTTER_BLOCKS);
    public static final Block WAXED_WEATHERED_YELLOW_COPPER_WALL_CANDLE = registerBlock("waxed_weathered_yellow_copper_wall_candle", new WallCandleBlock(FabricBlockSettings.copy(Blocks.COPPER_BLOCK).luminance(WallCandleBlock.createLightLevelFromLitBlockState(8))), ModItemGroups.CLUTTER_BLOCKS);
    public static final Block WAXED_WEATHERED_LIME_COPPER_WALL_CANDLE = registerBlock("waxed_weathered_lime_copper_wall_candle", new WallCandleBlock(FabricBlockSettings.copy(Blocks.COPPER_BLOCK).luminance(WallCandleBlock.createLightLevelFromLitBlockState(8))), ModItemGroups.CLUTTER_BLOCKS);
    public static final Block WAXED_WEATHERED_GREEN_COPPER_WALL_CANDLE = registerBlock("waxed_weathered_green_copper_wall_candle", new WallCandleBlock(FabricBlockSettings.copy(Blocks.COPPER_BLOCK).luminance(WallCandleBlock.createLightLevelFromLitBlockState(8))), ModItemGroups.CLUTTER_BLOCKS);
    public static final Block WAXED_WEATHERED_CYAN_COPPER_WALL_CANDLE = registerBlock("waxed_weathered_cyan_copper_wall_candle", new WallCandleBlock(FabricBlockSettings.copy(Blocks.COPPER_BLOCK).luminance(WallCandleBlock.createLightLevelFromLitBlockState(8))), ModItemGroups.CLUTTER_BLOCKS);
    public static final Block WAXED_WEATHERED_LIGHT_BLUE_COPPER_WALL_CANDLE = registerBlock("waxed_weathered_light_blue_copper_wall_candle", new WallCandleBlock(FabricBlockSettings.copy(Blocks.COPPER_BLOCK).luminance(WallCandleBlock.createLightLevelFromLitBlockState(8))), ModItemGroups.CLUTTER_BLOCKS);
    public static final Block WAXED_WEATHERED_BLUE_COPPER_WALL_CANDLE = registerBlock("waxed_weathered_blue_copper_wall_candle", new WallCandleBlock(FabricBlockSettings.copy(Blocks.COPPER_BLOCK).luminance(WallCandleBlock.createLightLevelFromLitBlockState(8))), ModItemGroups.CLUTTER_BLOCKS);
    public static final Block WAXED_WEATHERED_PURPLE_COPPER_WALL_CANDLE = registerBlock("waxed_weathered_purple_copper_wall_candle", new WallCandleBlock(FabricBlockSettings.copy(Blocks.COPPER_BLOCK).luminance(WallCandleBlock.createLightLevelFromLitBlockState(8))), ModItemGroups.CLUTTER_BLOCKS);
    public static final Block WAXED_WEATHERED_MAGENTA_COPPER_WALL_CANDLE = registerBlock("waxed_weathered_magenta_copper_wall_candle", new WallCandleBlock(FabricBlockSettings.copy(Blocks.COPPER_BLOCK).luminance(WallCandleBlock.createLightLevelFromLitBlockState(8))), ModItemGroups.CLUTTER_BLOCKS);
    public static final Block WAXED_WEATHERED_PINK_COPPER_WALL_CANDLE = registerBlock("waxed_weathered_pink_copper_wall_candle", new WallCandleBlock(FabricBlockSettings.copy(Blocks.COPPER_BLOCK).luminance(WallCandleBlock.createLightLevelFromLitBlockState(8))), ModItemGroups.CLUTTER_BLOCKS);

    public static final Block WAXED_OXIDIZED_COPPER_WALL_CANDLE = registerBlock("waxed_oxidized_copper_wall_candle", new WallCandleBlock(FabricBlockSettings.copy(Blocks.COPPER_BLOCK).luminance(WallCandleBlock.createLightLevelFromLitBlockState(8))), ModItemGroups.CLUTTER_BLOCKS);
    public static final Block WAXED_OXIDIZED_WHITE_COPPER_WALL_CANDLE = registerBlock("waxed_oxidized_white_copper_wall_candle", new WallCandleBlock(FabricBlockSettings.copy(Blocks.COPPER_BLOCK).luminance(WallCandleBlock.createLightLevelFromLitBlockState(8))), ModItemGroups.CLUTTER_BLOCKS);
    public static final Block WAXED_OXIDIZED_LIGHT_GRAY_COPPER_WALL_CANDLE = registerBlock("waxed_oxidized_light_gray_copper_wall_candle", new WallCandleBlock(FabricBlockSettings.copy(Blocks.COPPER_BLOCK).luminance(WallCandleBlock.createLightLevelFromLitBlockState(8))), ModItemGroups.CLUTTER_BLOCKS);
    public static final Block WAXED_OXIDIZED_GRAY_COPPER_WALL_CANDLE = registerBlock("waxed_oxidized_gray_copper_wall_candle", new WallCandleBlock(FabricBlockSettings.copy(Blocks.COPPER_BLOCK).luminance(WallCandleBlock.createLightLevelFromLitBlockState(8))), ModItemGroups.CLUTTER_BLOCKS);
    public static final Block WAXED_OXIDIZED_BLACK_COPPER_WALL_CANDLE = registerBlock("waxed_oxidized_black_copper_wall_candle", new WallCandleBlock(FabricBlockSettings.copy(Blocks.COPPER_BLOCK).luminance(WallCandleBlock.createLightLevelFromLitBlockState(8))), ModItemGroups.CLUTTER_BLOCKS);
    public static final Block WAXED_OXIDIZED_BROWN_COPPER_WALL_CANDLE = registerBlock("waxed_oxidized_brown_copper_wall_candle", new WallCandleBlock(FabricBlockSettings.copy(Blocks.COPPER_BLOCK).luminance(WallCandleBlock.createLightLevelFromLitBlockState(8))), ModItemGroups.CLUTTER_BLOCKS);
    public static final Block WAXED_OXIDIZED_RED_COPPER_WALL_CANDLE = registerBlock("waxed_oxidized_red_copper_wall_candle", new WallCandleBlock(FabricBlockSettings.copy(Blocks.COPPER_BLOCK).luminance(WallCandleBlock.createLightLevelFromLitBlockState(8))), ModItemGroups.CLUTTER_BLOCKS);
    public static final Block WAXED_OXIDIZED_ORANGE_COPPER_WALL_CANDLE = registerBlock("waxed_oxidized_orange_copper_wall_candle", new WallCandleBlock(FabricBlockSettings.copy(Blocks.COPPER_BLOCK).luminance(WallCandleBlock.createLightLevelFromLitBlockState(8))), ModItemGroups.CLUTTER_BLOCKS);
    public static final Block WAXED_OXIDIZED_YELLOW_COPPER_WALL_CANDLE = registerBlock("waxed_oxidized_yellow_copper_wall_candle", new WallCandleBlock(FabricBlockSettings.copy(Blocks.COPPER_BLOCK).luminance(WallCandleBlock.createLightLevelFromLitBlockState(8))), ModItemGroups.CLUTTER_BLOCKS);
    public static final Block WAXED_OXIDIZED_LIME_COPPER_WALL_CANDLE = registerBlock("waxed_oxidized_lime_copper_wall_candle", new WallCandleBlock(FabricBlockSettings.copy(Blocks.COPPER_BLOCK).luminance(WallCandleBlock.createLightLevelFromLitBlockState(8))), ModItemGroups.CLUTTER_BLOCKS);
    public static final Block WAXED_OXIDIZED_GREEN_COPPER_WALL_CANDLE = registerBlock("waxed_oxidized_green_copper_wall_candle", new WallCandleBlock(FabricBlockSettings.copy(Blocks.COPPER_BLOCK).luminance(WallCandleBlock.createLightLevelFromLitBlockState(8))), ModItemGroups.CLUTTER_BLOCKS);
    public static final Block WAXED_OXIDIZED_CYAN_COPPER_WALL_CANDLE = registerBlock("waxed_oxidized_cyan_copper_wall_candle", new WallCandleBlock(FabricBlockSettings.copy(Blocks.COPPER_BLOCK).luminance(WallCandleBlock.createLightLevelFromLitBlockState(8))), ModItemGroups.CLUTTER_BLOCKS);
    public static final Block WAXED_OXIDIZED_LIGHT_BLUE_COPPER_WALL_CANDLE = registerBlock("waxed_oxidized_light_blue_copper_wall_candle", new WallCandleBlock(FabricBlockSettings.copy(Blocks.COPPER_BLOCK).luminance(WallCandleBlock.createLightLevelFromLitBlockState(8))), ModItemGroups.CLUTTER_BLOCKS);
    public static final Block WAXED_OXIDIZED_BLUE_COPPER_WALL_CANDLE = registerBlock("waxed_oxidized_blue_copper_wall_candle", new WallCandleBlock(FabricBlockSettings.copy(Blocks.COPPER_BLOCK).luminance(WallCandleBlock.createLightLevelFromLitBlockState(8))), ModItemGroups.CLUTTER_BLOCKS);
    public static final Block WAXED_OXIDIZED_PURPLE_COPPER_WALL_CANDLE = registerBlock("waxed_oxidized_purple_copper_wall_candle", new WallCandleBlock(FabricBlockSettings.copy(Blocks.COPPER_BLOCK).luminance(WallCandleBlock.createLightLevelFromLitBlockState(8))), ModItemGroups.CLUTTER_BLOCKS);
    public static final Block WAXED_OXIDIZED_MAGENTA_COPPER_WALL_CANDLE = registerBlock("waxed_oxidized_magenta_copper_wall_candle", new WallCandleBlock(FabricBlockSettings.copy(Blocks.COPPER_BLOCK).luminance(WallCandleBlock.createLightLevelFromLitBlockState(8))), ModItemGroups.CLUTTER_BLOCKS);
    public static final Block WAXED_OXIDIZED_PINK_COPPER_WALL_CANDLE = registerBlock("waxed_oxidized_pink_copper_wall_candle", new WallCandleBlock(FabricBlockSettings.copy(Blocks.COPPER_BLOCK).luminance(WallCandleBlock.createLightLevelFromLitBlockState(8))), ModItemGroups.CLUTTER_BLOCKS);

    public static final Block COPPER_CHANDELIER = registerBlock("copper_chandelier", new OxidizableChandelierBlock(Oxidizable.OxidationLevel.UNAFFECTED, FabricBlockSettings.copy(Blocks.COPPER_BLOCK).luminance(ChandelierBlock.createLightLevelFromLitBlockState(12))), ModItemGroups.CLUTTER_BLOCKS);
    public static final Block WHITE_COPPER_CHANDELIER = registerBlock("white_copper_chandelier", new OxidizableChandelierBlock(Oxidizable.OxidationLevel.UNAFFECTED,FabricBlockSettings.copy(Blocks.COPPER_BLOCK).luminance(ChandelierBlock.createLightLevelFromLitBlockState(12))), ModItemGroups.CLUTTER_BLOCKS);
    public static final Block LIGHT_GRAY_COPPER_CHANDELIER = registerBlock("light_gray_copper_chandelier", new OxidizableChandelierBlock(Oxidizable.OxidationLevel.UNAFFECTED,FabricBlockSettings.copy(Blocks.COPPER_BLOCK).luminance(ChandelierBlock.createLightLevelFromLitBlockState(12))), ModItemGroups.CLUTTER_BLOCKS);
    public static final Block GRAY_COPPER_CHANDELIER = registerBlock("gray_copper_chandelier", new OxidizableChandelierBlock(Oxidizable.OxidationLevel.UNAFFECTED,FabricBlockSettings.copy(Blocks.COPPER_BLOCK).luminance(ChandelierBlock.createLightLevelFromLitBlockState(12))), ModItemGroups.CLUTTER_BLOCKS);
    public static final Block BLACK_COPPER_CHANDELIER = registerBlock("black_copper_chandelier", new OxidizableChandelierBlock(Oxidizable.OxidationLevel.UNAFFECTED,FabricBlockSettings.copy(Blocks.COPPER_BLOCK).luminance(ChandelierBlock.createLightLevelFromLitBlockState(12))), ModItemGroups.CLUTTER_BLOCKS);
    public static final Block BROWN_COPPER_CHANDELIER = registerBlock("brown_copper_chandelier", new OxidizableChandelierBlock(Oxidizable.OxidationLevel.UNAFFECTED,FabricBlockSettings.copy(Blocks.COPPER_BLOCK).luminance(ChandelierBlock.createLightLevelFromLitBlockState(12))), ModItemGroups.CLUTTER_BLOCKS);
    public static final Block RED_COPPER_CHANDELIER = registerBlock("red_copper_chandelier", new OxidizableChandelierBlock(Oxidizable.OxidationLevel.UNAFFECTED,FabricBlockSettings.copy(Blocks.COPPER_BLOCK).luminance(ChandelierBlock.createLightLevelFromLitBlockState(12))), ModItemGroups.CLUTTER_BLOCKS);
    public static final Block ORANGE_COPPER_CHANDELIER = registerBlock("orange_copper_chandelier", new OxidizableChandelierBlock(Oxidizable.OxidationLevel.UNAFFECTED,FabricBlockSettings.copy(Blocks.COPPER_BLOCK).luminance(ChandelierBlock.createLightLevelFromLitBlockState(12))), ModItemGroups.CLUTTER_BLOCKS);
    public static final Block YELLOW_COPPER_CHANDELIER = registerBlock("yellow_copper_chandelier", new OxidizableChandelierBlock(Oxidizable.OxidationLevel.UNAFFECTED,FabricBlockSettings.copy(Blocks.COPPER_BLOCK).luminance(ChandelierBlock.createLightLevelFromLitBlockState(12))), ModItemGroups.CLUTTER_BLOCKS);
    public static final Block LIME_COPPER_CHANDELIER = registerBlock("lime_copper_chandelier", new OxidizableChandelierBlock(Oxidizable.OxidationLevel.UNAFFECTED,FabricBlockSettings.copy(Blocks.COPPER_BLOCK).luminance(ChandelierBlock.createLightLevelFromLitBlockState(12))), ModItemGroups.CLUTTER_BLOCKS);
    public static final Block GREEN_COPPER_CHANDELIER = registerBlock("green_copper_chandelier", new OxidizableChandelierBlock(Oxidizable.OxidationLevel.UNAFFECTED,FabricBlockSettings.copy(Blocks.COPPER_BLOCK).luminance(ChandelierBlock.createLightLevelFromLitBlockState(12))), ModItemGroups.CLUTTER_BLOCKS);
    public static final Block CYAN_COPPER_CHANDELIER = registerBlock("cyan_copper_chandelier", new OxidizableChandelierBlock(Oxidizable.OxidationLevel.UNAFFECTED,FabricBlockSettings.copy(Blocks.COPPER_BLOCK).luminance(ChandelierBlock.createLightLevelFromLitBlockState(12))), ModItemGroups.CLUTTER_BLOCKS);
    public static final Block LIGHT_BLUE_COPPER_CHANDELIER = registerBlock("light_blue_copper_chandelier", new OxidizableChandelierBlock(Oxidizable.OxidationLevel.UNAFFECTED,FabricBlockSettings.copy(Blocks.COPPER_BLOCK).luminance(ChandelierBlock.createLightLevelFromLitBlockState(12))), ModItemGroups.CLUTTER_BLOCKS);
    public static final Block BLUE_COPPER_CHANDELIER = registerBlock("blue_copper_chandelier", new OxidizableChandelierBlock(Oxidizable.OxidationLevel.UNAFFECTED,FabricBlockSettings.copy(Blocks.COPPER_BLOCK).luminance(ChandelierBlock.createLightLevelFromLitBlockState(12))), ModItemGroups.CLUTTER_BLOCKS);
    public static final Block PURPLE_COPPER_CHANDELIER = registerBlock("purple_copper_chandelier", new OxidizableChandelierBlock(Oxidizable.OxidationLevel.UNAFFECTED,FabricBlockSettings.copy(Blocks.COPPER_BLOCK).luminance(ChandelierBlock.createLightLevelFromLitBlockState(12))), ModItemGroups.CLUTTER_BLOCKS);
    public static final Block MAGENTA_COPPER_CHANDELIER = registerBlock("magenta_copper_chandelier", new OxidizableChandelierBlock(Oxidizable.OxidationLevel.UNAFFECTED,FabricBlockSettings.copy(Blocks.COPPER_BLOCK).luminance(ChandelierBlock.createLightLevelFromLitBlockState(12))), ModItemGroups.CLUTTER_BLOCKS);
    public static final Block PINK_COPPER_CHANDELIER = registerBlock("pink_copper_chandelier", new OxidizableChandelierBlock(Oxidizable.OxidationLevel.UNAFFECTED,FabricBlockSettings.copy(Blocks.COPPER_BLOCK).luminance(ChandelierBlock.createLightLevelFromLitBlockState(12))), ModItemGroups.CLUTTER_BLOCKS);

    public static final Block EXPOSED_COPPER_CHANDELIER = registerBlock("exposed_copper_chandelier", new OxidizableChandelierBlock(Oxidizable.OxidationLevel.EXPOSED, FabricBlockSettings.copy(Blocks.EXPOSED_COPPER).luminance(ChandelierBlock.createLightLevelFromLitBlockState(12))), ModItemGroups.CLUTTER_BLOCKS);
    ...
    public static final Block OXIDIZED_COPPER_CHANDELIER = registerBlock("oxidized_copper_chandelier", new OxidizableChandelierBlock(Oxidizable.OxidationLevel.OXIDIZED, FabricBlockSettings.copy(Blocks.WEATHERED_COPPER).luminance(ChandelierBlock.createLightLevelFromLitBlockState(12))), ModItemGroups.CLUTTER_BLOCKS);
    ...
    public static final Block WAXED_COPPER_CHANDELIER = registerBlock("waxed_copper_chandelier", new ChandelierBlock(FabricBlockSettings.copy(Blocks.COPPER_BLOCK).luminance(ChandelierBlock.createLightLevelFromLitBlockState(12))), ModItemGroups.CLUTTER_BLOCKS);
    public static final Block WAXED_WHITE_COPPER_CHANDELIER = registerBlock("waxed_white_copper_chandelier", new ChandelierBlock(FabricBlockSettings.copy(Blocks.COPPER_BLOCK).luminance(ChandelierBlock.createLightLevelFromLitBlockState(12))), ModItemGroups.CLUTTER_BLOCKS);
    public static final Block WAXED_LIGHT_GRAY_COPPER_CHANDELIER = registerBlock("waxed_light_gray_copper_chandelier", new ChandelierBlock(FabricBlockSettings.copy(Blocks.COPPER_BLOCK).luminance(ChandelierBlock.createLightLevelFromLitBlockState(12))), ModItemGroups.CLUTTER_BLOCKS);
    public static final Block WAXED_GRAY_COPPER_CHANDELIER = registerBlock("waxed_gray_copper_chandelier", new ChandelierBlock(FabricBlockSettings.copy(Blocks.COPPER_BLOCK).luminance(ChandelierBlock.createLightLevelFromLitBlockState(12))), ModItemGroups.CLUTTER_BLOCKS);
    public static final Block WAXED_BLACK_COPPER_CHANDELIER = registerBlock("waxed_black_copper_chandelier", new ChandelierBlock(FabricBlockSettings.copy(Blocks.COPPER_BLOCK).luminance(ChandelierBlock.createLightLevelFromLitBlockState(12))), ModItemGroups.CLUTTER_BLOCKS);
    public static final Block WAXED_BROWN_COPPER_CHANDELIER = registerBlock("waxed_brown_copper_chandelier", new ChandelierBlock(FabricBlockSettings.copy(Blocks.COPPER_BLOCK).luminance(ChandelierBlock.createLightLevelFromLitBlockState(12))), ModItemGroups.CLUTTER_BLOCKS);
    public static final Block WAXED_RED_COPPER_CHANDELIER = registerBlock("waxed_red_copper_chandelier", new ChandelierBlock(FabricBlockSettings.copy(Blocks.COPPER_BLOCK).luminance(ChandelierBlock.createLightLevelFromLitBlockState(12))), ModItemGroups.CLUTTER_BLOCKS);
    public static final Block WAXED_ORANGE_COPPER_CHANDELIER = registerBlock("waxed_orange_copper_chandelier", new ChandelierBlock(FabricBlockSettings.copy(Blocks.COPPER_BLOCK).luminance(ChandelierBlock.createLightLevelFromLitBlockState(12))), ModItemGroups.CLUTTER_BLOCKS);
    public static final Block WAXED_YELLOW_COPPER_CHANDELIER = registerBlock("waxed_yellow_copper_chandelier", new ChandelierBlock(FabricBlockSettings.copy(Blocks.COPPER_BLOCK).luminance(ChandelierBlock.createLightLevelFromLitBlockState(12))), ModItemGroups.CLUTTER_BLOCKS);
    public static final Block WAXED_LIME_COPPER_CHANDELIER = registerBlock("waxed_lime_copper_chandelier", new ChandelierBlock(FabricBlockSettings.copy(Blocks.COPPER_BLOCK).luminance(ChandelierBlock.createLightLevelFromLitBlockState(12))), ModItemGroups.CLUTTER_BLOCKS);
    public static final Block WAXED_GREEN_COPPER_CHANDELIER = registerBlock("waxed_green_copper_chandelier", new ChandelierBlock(FabricBlockSettings.copy(Blocks.COPPER_BLOCK).luminance(ChandelierBlock.createLightLevelFromLitBlockState(12))), ModItemGroups.CLUTTER_BLOCKS);
    public static final Block WAXED_CYAN_COPPER_CHANDELIER = registerBlock("waxed_cyan_copper_chandelier", new ChandelierBlock(FabricBlockSettings.copy(Blocks.COPPER_BLOCK).luminance(ChandelierBlock.createLightLevelFromLitBlockState(12))), ModItemGroups.CLUTTER_BLOCKS);
    public static final Block WAXED_LIGHT_BLUE_COPPER_CHANDELIER = registerBlock("waxed_light_blue_copper_chandelier", new ChandelierBlock(FabricBlockSettings.copy(Blocks.COPPER_BLOCK).luminance(ChandelierBlock.createLightLevelFromLitBlockState(12))), ModItemGroups.CLUTTER_BLOCKS);
    public static final Block WAXED_BLUE_COPPER_CHANDELIER = registerBlock("waxed_blue_copper_chandelier", new ChandelierBlock(FabricBlockSettings.copy(Blocks.COPPER_BLOCK).luminance(ChandelierBlock.createLightLevelFromLitBlockState(12))), ModItemGroups.CLUTTER_BLOCKS);
    public static final Block WAXED_PURPLE_COPPER_CHANDELIER = registerBlock("waxed_purple_copper_chandelier", new ChandelierBlock(FabricBlockSettings.copy(Blocks.COPPER_BLOCK).luminance(ChandelierBlock.createLightLevelFromLitBlockState(12))), ModItemGroups.CLUTTER_BLOCKS);
    public static final Block WAXED_MAGENTA_COPPER_CHANDELIER = registerBlock("waxed_magenta_copper_chandelier", new ChandelierBlock(FabricBlockSettings.copy(Blocks.COPPER_BLOCK).luminance(ChandelierBlock.createLightLevelFromLitBlockState(12))), ModItemGroups.CLUTTER_BLOCKS);
    public static final Block WAXED_PINK_COPPER_CHANDELIER = registerBlock("waxed_pink_copper_chandelier", new ChandelierBlock(FabricBlockSettings.copy(Blocks.COPPER_BLOCK).luminance(ChandelierBlock.createLightLevelFromLitBlockState(12))), ModItemGroups.CLUTTER_BLOCKS);

    public static final Block WAXED_EXPOSED_COPPER_CHANDELIER = registerBlock("waxed_exposed_copper_chandelier", new ChandelierBlock(FabricBlockSettings.copy(Blocks.COPPER_BLOCK).luminance(ChandelierBlock.createLightLevelFromLitBlockState(12))), ModItemGroups.CLUTTER_BLOCKS);
    public static final Block WAXED_EXPOSED_WHITE_COPPER_CHANDELIER = registerBlock("waxed_exposed_white_copper_chandelier", new ChandelierBlock(FabricBlockSettings.copy(Blocks.COPPER_BLOCK).luminance(ChandelierBlock.createLightLevelFromLitBlockState(12))), ModItemGroups.CLUTTER_BLOCKS);
    public static final Block WAXED_EXPOSED_LIGHT_GRAY_COPPER_CHANDELIER = registerBlock("waxed_exposed_light_gray_copper_chandelier", new ChandelierBlock(FabricBlockSettings.copy(Blocks.COPPER_BLOCK).luminance(ChandelierBlock.createLightLevelFromLitBlockState(12))), ModItemGroups.CLUTTER_BLOCKS);
    public static final Block WAXED_EXPOSED_GRAY_COPPER_CHANDELIER = registerBlock("waxed_exposed_gray_copper_chandelier", new ChandelierBlock(FabricBlockSettings.copy(Blocks.COPPER_BLOCK).luminance(ChandelierBlock.createLightLevelFromLitBlockState(12))), ModItemGroups.CLUTTER_BLOCKS);
    public static final Block WAXED_EXPOSED_BLACK_COPPER_CHANDELIER = registerBlock("waxed_exposed_black_copper_chandelier", new ChandelierBlock(FabricBlockSettings.copy(Blocks.COPPER_BLOCK).luminance(ChandelierBlock.createLightLevelFromLitBlockState(12))), ModItemGroups.CLUTTER_BLOCKS);
    public static final Block WAXED_EXPOSED_BROWN_COPPER_CHANDELIER = registerBlock("waxed_exposed_brown_copper_chandelier", new ChandelierBlock(FabricBlockSettings.copy(Blocks.COPPER_BLOCK).luminance(ChandelierBlock.createLightLevelFromLitBlockState(12))), ModItemGroups.CLUTTER_BLOCKS);
    public static final Block WAXED_EXPOSED_RED_COPPER_CHANDELIER = registerBlock("waxed_exposed_red_copper_chandelier", new ChandelierBlock(FabricBlockSettings.copy(Blocks.COPPER_BLOCK).luminance(ChandelierBlock.createLightLevelFromLitBlockState(12))), ModItemGroups.CLUTTER_BLOCKS);
    public static final Block WAXED_EXPOSED_ORANGE_COPPER_CHANDELIER = registerBlock("waxed_exposed_orange_copper_chandelier", new ChandelierBlock(FabricBlockSettings.copy(Blocks.COPPER_BLOCK).luminance(ChandelierBlock.createLightLevelFromLitBlockState(12))), ModItemGroups.CLUTTER_BLOCKS);
    public static final Block WAXED_EXPOSED_YELLOW_COPPER_CHANDELIER = registerBlock("waxed_exposed_yellow_copper_chandelier", new ChandelierBlock(FabricBlockSettings.copy(Blocks.COPPER_BLOCK).luminance(ChandelierBlock.createLightLevelFromLitBlockState(12))), ModItemGroups.CLUTTER_BLOCKS);
    public static final Block WAXED_EXPOSED_LIME_COPPER_CHANDELIER = registerBlock("waxed_exposed_lime_copper_chandelier", new ChandelierBlock(FabricBlockSettings.copy(Blocks.COPPER_BLOCK).luminance(ChandelierBlock.createLightLevelFromLitBlockState(12))), ModItemGroups.CLUTTER_BLOCKS);
    public static final Block WAXED_EXPOSED_GREEN_COPPER_CHANDELIER = registerBlock("waxed_exposed_green_copper_chandelier", new ChandelierBlock(FabricBlockSettings.copy(Blocks.COPPER_BLOCK).luminance(ChandelierBlock.createLightLevelFromLitBlockState(12))), ModItemGroups.CLUTTER_BLOCKS);
    public static final Block WAXED_EXPOSED_CYAN_COPPER_CHANDELIER = registerBlock("waxed_exposed_cyan_copper_chandelier", new ChandelierBlock(FabricBlockSettings.copy(Blocks.COPPER_BLOCK).luminance(ChandelierBlock.createLightLevelFromLitBlockState(12))), ModItemGroups.CLUTTER_BLOCKS);
    public static final Block WAXED_EXPOSED_LIGHT_BLUE_COPPER_CHANDELIER = registerBlock("waxed_exposed_light_blue_copper_chandelier", new ChandelierBlock(FabricBlockSettings.copy(Blocks.COPPER_BLOCK).luminance(ChandelierBlock.createLightLevelFromLitBlockState(12))), ModItemGroups.CLUTTER_BLOCKS);
    public static final Block WAXED_EXPOSED_BLUE_COPPER_CHANDELIER = registerBlock("waxed_exposed_blue_copper_chandelier", new ChandelierBlock(FabricBlockSettings.copy(Blocks.COPPER_BLOCK).luminance(ChandelierBlock.createLightLevelFromLitBlockState(12))), ModItemGroups.CLUTTER_BLOCKS);
    public static final Block WAXED_EXPOSED_PURPLE_COPPER_CHANDELIER = registerBlock("waxed_exposed_purple_copper_chandelier", new ChandelierBlock(FabricBlockSettings.copy(Blocks.COPPER_BLOCK).luminance(ChandelierBlock.createLightLevelFromLitBlockState(12))), ModItemGroups.CLUTTER_BLOCKS);
    public static final Block WAXED_EXPOSED_MAGENTA_COPPER_CHANDELIER = registerBlock("waxed_exposed_magenta_copper_chandelier", new ChandelierBlock(FabricBlockSettings.copy(Blocks.COPPER_BLOCK).luminance(ChandelierBlock.createLightLevelFromLitBlockState(12))), ModItemGroups.CLUTTER_BLOCKS);
    public static final Block WAXED_EXPOSED_PINK_COPPER_CHANDELIER = registerBlock("waxed_exposed_pink_copper_chandelier", new ChandelierBlock(FabricBlockSettings.copy(Blocks.COPPER_BLOCK).luminance(ChandelierBlock.createLightLevelFromLitBlockState(12))), ModItemGroups.CLUTTER_BLOCKS);

    public static final Block WAXED_WEATHERED_COPPER_CHANDELIER = registerBlock("waxed_weathered_copper_chandelier", new ChandelierBlock(FabricBlockSettings.copy(Blocks.COPPER_BLOCK).luminance(ChandelierBlock.createLightLevelFromLitBlockState(12))), ModItemGroups.CLUTTER_BLOCKS);
    public static final Block WAXED_WEATHERED_WHITE_COPPER_CHANDELIER = registerBlock("waxed_weathered_white_copper_chandelier", new ChandelierBlock(FabricBlockSettings.copy(Blocks.COPPER_BLOCK).luminance(ChandelierBlock.createLightLevelFromLitBlockState(12))), ModItemGroups.CLUTTER_BLOCKS);
    public static final Block WAXED_WEATHERED_LIGHT_GRAY_COPPER_CHANDELIER = registerBlock("waxed_weathered_light_gray_copper_chandelier", new ChandelierBlock(FabricBlockSettings.copy(Blocks.COPPER_BLOCK).luminance(ChandelierBlock.createLightLevelFromLitBlockState(12))), ModItemGroups.CLUTTER_BLOCKS);
    public static final Block WAXED_WEATHERED_GRAY_COPPER_CHANDELIER = registerBlock("waxed_weathered_gray_copper_chandelier", new ChandelierBlock(FabricBlockSettings.copy(Blocks.COPPER_BLOCK).luminance(ChandelierBlock.createLightLevelFromLitBlockState(12))), ModItemGroups.CLUTTER_BLOCKS);
    public static final Block WAXED_WEATHERED_BLACK_COPPER_CHANDELIER = registerBlock("waxed_weathered_black_copper_chandelier", new ChandelierBlock(FabricBlockSettings.copy(Blocks.COPPER_BLOCK).luminance(ChandelierBlock.createLightLevelFromLitBlockState(12))), ModItemGroups.CLUTTER_BLOCKS);
    public static final Block WAXED_WEATHERED_BROWN_COPPER_CHANDELIER = registerBlock("waxed_weathered_brown_copper_chandelier", new ChandelierBlock(FabricBlockSettings.copy(Blocks.COPPER_BLOCK).luminance(ChandelierBlock.createLightLevelFromLitBlockState(12))), ModItemGroups.CLUTTER_BLOCKS);
    public static final Block WAXED_WEATHERED_RED_COPPER_CHANDELIER = registerBlock("waxed_weathered_red_copper_chandelier", new ChandelierBlock(FabricBlockSettings.copy(Blocks.COPPER_BLOCK).luminance(ChandelierBlock.createLightLevelFromLitBlockState(12))), ModItemGroups.CLUTTER_BLOCKS);
    public static final Block WAXED_WEATHERED_ORANGE_COPPER_CHANDELIER = registerBlock("waxed_weathered_orange_copper_chandelier", new ChandelierBlock(FabricBlockSettings.copy(Blocks.COPPER_BLOCK).luminance(ChandelierBlock.createLightLevelFromLitBlockState(12))), ModItemGroups.CLUTTER_BLOCKS);
    public static final Block WAXED_WEATHERED_YELLOW_COPPER_CHANDELIER = registerBlock("waxed_weathered_yellow_copper_chandelier", new ChandelierBlock(FabricBlockSettings.copy(Blocks.COPPER_BLOCK).luminance(ChandelierBlock.createLightLevelFromLitBlockState(12))), ModItemGroups.CLUTTER_BLOCKS);
    public static final Block WAXED_WEATHERED_LIME_COPPER_CHANDELIER = registerBlock("waxed_weathered_lime_copper_chandelier", new ChandelierBlock(FabricBlockSettings.copy(Blocks.COPPER_BLOCK).luminance(ChandelierBlock.createLightLevelFromLitBlockState(12))), ModItemGroups.CLUTTER_BLOCKS);
    public static final Block WAXED_WEATHERED_GREEN_COPPER_CHANDELIER = registerBlock("waxed_weathered_green_copper_chandelier", new ChandelierBlock(FabricBlockSettings.copy(Blocks.COPPER_BLOCK).luminance(ChandelierBlock.createLightLevelFromLitBlockState(12))), ModItemGroups.CLUTTER_BLOCKS);
    public static final Block WAXED_WEATHERED_CYAN_COPPER_CHANDELIER = registerBlock("waxed_weathered_cyan_copper_chandelier", new ChandelierBlock(FabricBlockSettings.copy(Blocks.COPPER_BLOCK).luminance(ChandelierBlock.createLightLevelFromLitBlockState(12))), ModItemGroups.CLUTTER_BLOCKS);
    public static final Block WAXED_WEATHERED_LIGHT_BLUE_COPPER_CHANDELIER = registerBlock("waxed_weathered_light_blue_copper_chandelier", new ChandelierBlock(FabricBlockSettings.copy(Blocks.COPPER_BLOCK).luminance(ChandelierBlock.createLightLevelFromLitBlockState(12))), ModItemGroups.CLUTTER_BLOCKS);
    public static final Block WAXED_WEATHERED_BLUE_COPPER_CHANDELIER = registerBlock("waxed_weathered_blue_copper_chandelier", new ChandelierBlock(FabricBlockSettings.copy(Blocks.COPPER_BLOCK).luminance(ChandelierBlock.createLightLevelFromLitBlockState(12))), ModItemGroups.CLUTTER_BLOCKS);
    public static final Block WAXED_WEATHERED_PURPLE_COPPER_CHANDELIER = registerBlock("waxed_weathered_purple_copper_chandelier", new ChandelierBlock(FabricBlockSettings.copy(Blocks.COPPER_BLOCK).luminance(ChandelierBlock.createLightLevelFromLitBlockState(12))), ModItemGroups.CLUTTER_BLOCKS);
    public static final Block WAXED_WEATHERED_MAGENTA_COPPER_CHANDELIER = registerBlock("waxed_weathered_magenta_copper_chandelier", new ChandelierBlock(FabricBlockSettings.copy(Blocks.COPPER_BLOCK).luminance(ChandelierBlock.createLightLevelFromLitBlockState(12))), ModItemGroups.CLUTTER_BLOCKS);
    public static final Block WAXED_WEATHERED_PINK_COPPER_CHANDELIER = registerBlock("waxed_weathered_pink_copper_chandelier", new ChandelierBlock(FabricBlockSettings.copy(Blocks.COPPER_BLOCK).luminance(ChandelierBlock.createLightLevelFromLitBlockState(12))), ModItemGroups.CLUTTER_BLOCKS);

    public static final Block WAXED_OXIDIZED_COPPER_CHANDELIER = registerBlock("waxed_oxidized_copper_chandelier", new ChandelierBlock(FabricBlockSettings.copy(Blocks.COPPER_BLOCK).luminance(ChandelierBlock.createLightLevelFromLitBlockState(12))), ModItemGroups.CLUTTER_BLOCKS);
    public static final Block WAXED_OXIDIZED_WHITE_COPPER_CHANDELIER = registerBlock("waxed_oxidized_white_copper_chandelier", new ChandelierBlock(FabricBlockSettings.copy(Blocks.COPPER_BLOCK).luminance(ChandelierBlock.createLightLevelFromLitBlockState(12))), ModItemGroups.CLUTTER_BLOCKS);
    public static final Block WAXED_OXIDIZED_LIGHT_GRAY_COPPER_CHANDELIER = registerBlock("waxed_oxidized_light_gray_copper_chandelier", new ChandelierBlock(FabricBlockSettings.copy(Blocks.COPPER_BLOCK).luminance(ChandelierBlock.createLightLevelFromLitBlockState(12))), ModItemGroups.CLUTTER_BLOCKS);
    public static final Block WAXED_OXIDIZED_GRAY_COPPER_CHANDELIER = registerBlock("waxed_oxidized_gray_copper_chandelier", new ChandelierBlock(FabricBlockSettings.copy(Blocks.COPPER_BLOCK).luminance(ChandelierBlock.createLightLevelFromLitBlockState(12))), ModItemGroups.CLUTTER_BLOCKS);
    public static final Block WAXED_OXIDIZED_BLACK_COPPER_CHANDELIER = registerBlock("waxed_oxidized_black_copper_chandelier", new ChandelierBlock(FabricBlockSettings.copy(Blocks.COPPER_BLOCK).luminance(ChandelierBlock.createLightLevelFromLitBlockState(12))), ModItemGroups.CLUTTER_BLOCKS);
    public static final Block WAXED_OXIDIZED_BROWN_COPPER_CHANDELIER = registerBlock("waxed_oxidized_brown_copper_chandelier", new ChandelierBlock(FabricBlockSettings.copy(Blocks.COPPER_BLOCK).luminance(ChandelierBlock.createLightLevelFromLitBlockState(12))), ModItemGroups.CLUTTER_BLOCKS);
    public static final Block WAXED_OXIDIZED_RED_COPPER_CHANDELIER = registerBlock("waxed_oxidized_red_copper_chandelier", new ChandelierBlock(FabricBlockSettings.copy(Blocks.COPPER_BLOCK).luminance(ChandelierBlock.createLightLevelFromLitBlockState(12))), ModItemGroups.CLUTTER_BLOCKS);
    public static final Block WAXED_OXIDIZED_ORANGE_COPPER_CHANDELIER = registerBlock("waxed_oxidized_orange_copper_chandelier", new ChandelierBlock(FabricBlockSettings.copy(Blocks.COPPER_BLOCK).luminance(ChandelierBlock.createLightLevelFromLitBlockState(12))), ModItemGroups.CLUTTER_BLOCKS);
    public static final Block WAXED_OXIDIZED_YELLOW_COPPER_CHANDELIER = registerBlock("waxed_oxidized_yellow_copper_chandelier", new ChandelierBlock(FabricBlockSettings.copy(Blocks.COPPER_BLOCK).luminance(ChandelierBlock.createLightLevelFromLitBlockState(12))), ModItemGroups.CLUTTER_BLOCKS);
    public static final Block WAXED_OXIDIZED_LIME_COPPER_CHANDELIER = registerBlock("waxed_oxidized_lime_copper_chandelier", new ChandelierBlock(FabricBlockSettings.copy(Blocks.COPPER_BLOCK).luminance(ChandelierBlock.createLightLevelFromLitBlockState(12))), ModItemGroups.CLUTTER_BLOCKS);
    public static final Block WAXED_OXIDIZED_GREEN_COPPER_CHANDELIER = registerBlock("waxed_oxidized_green_copper_chandelier", new ChandelierBlock(FabricBlockSettings.copy(Blocks.COPPER_BLOCK).luminance(ChandelierBlock.createLightLevelFromLitBlockState(12))), ModItemGroups.CLUTTER_BLOCKS);
    public static final Block WAXED_OXIDIZED_CYAN_COPPER_CHANDELIER = registerBlock("waxed_oxidized_cyan_copper_chandelier", new ChandelierBlock(FabricBlockSettings.copy(Blocks.COPPER_BLOCK).luminance(ChandelierBlock.createLightLevelFromLitBlockState(12))), ModItemGroups.CLUTTER_BLOCKS);
    public static final Block WAXED_OXIDIZED_LIGHT_BLUE_COPPER_CHANDELIER = registerBlock("waxed_oxidized_light_blue_copper_chandelier", new ChandelierBlock(FabricBlockSettings.copy(Blocks.COPPER_BLOCK).luminance(ChandelierBlock.createLightLevelFromLitBlockState(12))), ModItemGroups.CLUTTER_BLOCKS);
    public static final Block WAXED_OXIDIZED_BLUE_COPPER_CHANDELIER = registerBlock("waxed_oxidized_blue_copper_chandelier", new ChandelierBlock(FabricBlockSettings.copy(Blocks.COPPER_BLOCK).luminance(ChandelierBlock.createLightLevelFromLitBlockState(12))), ModItemGroups.CLUTTER_BLOCKS);
    public static final Block WAXED_OXIDIZED_PURPLE_COPPER_CHANDELIER = registerBlock("waxed_oxidized_purple_copper_chandelier", new ChandelierBlock(FabricBlockSettings.copy(Blocks.COPPER_BLOCK).luminance(ChandelierBlock.createLightLevelFromLitBlockState(12))), ModItemGroups.CLUTTER_BLOCKS);
    public static final Block WAXED_OXIDIZED_MAGENTA_COPPER_CHANDELIER = registerBlock("waxed_oxidized_magenta_copper_chandelier", new ChandelierBlock(FabricBlockSettings.copy(Blocks.COPPER_BLOCK).luminance(ChandelierBlock.createLightLevelFromLitBlockState(12))), ModItemGroups.CLUTTER_BLOCKS);
    public static final Block WAXED_OXIDIZED_PINK_COPPER_CHANDELIER = registerBlock("waxed_oxidized_pink_copper_chandelier", new ChandelierBlock(FabricBlockSettings.copy(Blocks.COPPER_BLOCK).luminance(ChandelierBlock.createLightLevelFromLitBlockState(12))), ModItemGroups.CLUTTER_BLOCKS);

    public static final Block IRON_CHANDELIER = registerBlock("iron_chandelier", new ChandelierBlock( FabricBlockSettings.copy(Blocks.IRON_BLOCK).luminance(ChandelierBlock.createLightLevelFromLitBlockState(12))), ModItemGroups.CLUTTER_BLOCKS);
    public static final Block WHITE_IRON_CHANDELIER = registerBlock("white_iron_chandelier", new ChandelierBlock(FabricBlockSettings.copy(Blocks.IRON_BLOCK).luminance(ChandelierBlock.createLightLevelFromLitBlockState(12))), ModItemGroups.CLUTTER_BLOCKS);
    public static final Block LIGHT_GRAY_IRON_CHANDELIER = registerBlock("light_gray_iron_chandelier", new ChandelierBlock(FabricBlockSettings.copy(Blocks.IRON_BLOCK).luminance(ChandelierBlock.createLightLevelFromLitBlockState(12))), ModItemGroups.CLUTTER_BLOCKS);
    public static final Block GRAY_IRON_CHANDELIER = registerBlock("gray_iron_chandelier", new ChandelierBlock(FabricBlockSettings.copy(Blocks.IRON_BLOCK).luminance(ChandelierBlock.createLightLevelFromLitBlockState(12))), ModItemGroups.CLUTTER_BLOCKS);
    public static final Block BLACK_IRON_CHANDELIER = registerBlock("black_iron_chandelier", new ChandelierBlock(FabricBlockSettings.copy(Blocks.IRON_BLOCK).luminance(ChandelierBlock.createLightLevelFromLitBlockState(12))), ModItemGroups.CLUTTER_BLOCKS);
    public static final Block BROWN_IRON_CHANDELIER = registerBlock("brown_iron_chandelier", new ChandelierBlock(FabricBlockSettings.copy(Blocks.IRON_BLOCK).luminance(ChandelierBlock.createLightLevelFromLitBlockState(12))), ModItemGroups.CLUTTER_BLOCKS);
    public static final Block RED_IRON_CHANDELIER = registerBlock("red_iron_chandelier", new ChandelierBlock(FabricBlockSettings.copy(Blocks.IRON_BLOCK).luminance(ChandelierBlock.createLightLevelFromLitBlockState(12))), ModItemGroups.CLUTTER_BLOCKS);
    public static final Block ORANGE_IRON_CHANDELIER = registerBlock("orange_iron_chandelier", new ChandelierBlock(FabricBlockSettings.copy(Blocks.IRON_BLOCK).luminance(ChandelierBlock.createLightLevelFromLitBlockState(12))), ModItemGroups.CLUTTER_BLOCKS);
    public static final Block YELLOW_IRON_CHANDELIER = registerBlock("yellow_iron_chandelier", new ChandelierBlock(FabricBlockSettings.copy(Blocks.IRON_BLOCK).luminance(ChandelierBlock.createLightLevelFromLitBlockState(12))), ModItemGroups.CLUTTER_BLOCKS);
    public static final Block LIME_IRON_CHANDELIER = registerBlock("lime_iron_chandelier", new ChandelierBlock(FabricBlockSettings.copy(Blocks.IRON_BLOCK).luminance(ChandelierBlock.createLightLevelFromLitBlockState(12))), ModItemGroups.CLUTTER_BLOCKS);
    public static final Block GREEN_IRON_CHANDELIER = registerBlock("green_iron_chandelier", new ChandelierBlock(FabricBlockSettings.copy(Blocks.IRON_BLOCK).luminance(ChandelierBlock.createLightLevelFromLitBlockState(12))), ModItemGroups.CLUTTER_BLOCKS);
    public static final Block CYAN_IRON_CHANDELIER = registerBlock("cyan_iron_chandelier", new ChandelierBlock(FabricBlockSettings.copy(Blocks.IRON_BLOCK).luminance(ChandelierBlock.createLightLevelFromLitBlockState(12))), ModItemGroups.CLUTTER_BLOCKS);
    public static final Block LIGHT_BLUE_IRON_CHANDELIER = registerBlock("light_blue_iron_chandelier", new ChandelierBlock(FabricBlockSettings.copy(Blocks.IRON_BLOCK).luminance(ChandelierBlock.createLightLevelFromLitBlockState(12))), ModItemGroups.CLUTTER_BLOCKS);
    public static final Block BLUE_IRON_CHANDELIER = registerBlock("blue_iron_chandelier", new ChandelierBlock(FabricBlockSettings.copy(Blocks.IRON_BLOCK).luminance(ChandelierBlock.createLightLevelFromLitBlockState(12))), ModItemGroups.CLUTTER_BLOCKS);
    public static final Block PURPLE_IRON_CHANDELIER = registerBlock("purple_iron_chandelier", new ChandelierBlock(FabricBlockSettings.copy(Blocks.IRON_BLOCK).luminance(ChandelierBlock.createLightLevelFromLitBlockState(12))), ModItemGroups.CLUTTER_BLOCKS);
    public static final Block MAGENTA_IRON_CHANDELIER = registerBlock("magenta_iron_chandelier", new ChandelierBlock(FabricBlockSettings.copy(Blocks.IRON_BLOCK).luminance(ChandelierBlock.createLightLevelFromLitBlockState(12))), ModItemGroups.CLUTTER_BLOCKS);
    public static final Block PINK_IRON_CHANDELIER = registerBlock("pink_iron_chandelier", new ChandelierBlock(FabricBlockSettings.copy(Blocks.IRON_BLOCK).luminance(ChandelierBlock.createLightLevelFromLitBlockState(12))), ModItemGroups.CLUTTER_BLOCKS);

    public static final Block GOLDEN_CHANDELIER = registerBlock("golden_chandelier", new ChandelierBlock( FabricBlockSettings.copy(Blocks.GOLD_BLOCK).luminance(ChandelierBlock.createLightLevelFromLitBlockState(12))), ModItemGroups.CLUTTER_BLOCKS);
    public static final Block WHITE_GOLDEN_CHANDELIER = registerBlock("white_golden_chandelier", new ChandelierBlock(FabricBlockSettings.copy(Blocks.GOLD_BLOCK).luminance(ChandelierBlock.createLightLevelFromLitBlockState(12))), ModItemGroups.CLUTTER_BLOCKS);
    public static final Block LIGHT_GRAY_GOLDEN_CHANDELIER = registerBlock("light_gray_golden_chandelier", new ChandelierBlock(FabricBlockSettings.copy(Blocks.GOLD_BLOCK).luminance(ChandelierBlock.createLightLevelFromLitBlockState(12))), ModItemGroups.CLUTTER_BLOCKS);
    public static final Block GRAY_GOLDEN_CHANDELIER = registerBlock("gray_golden_chandelier", new ChandelierBlock(FabricBlockSettings.copy(Blocks.GOLD_BLOCK).luminance(ChandelierBlock.createLightLevelFromLitBlockState(12))), ModItemGroups.CLUTTER_BLOCKS);
    public static final Block BLACK_GOLDEN_CHANDELIER = registerBlock("black_golden_chandelier", new ChandelierBlock(FabricBlockSettings.copy(Blocks.GOLD_BLOCK).luminance(ChandelierBlock.createLightLevelFromLitBlockState(12))), ModItemGroups.CLUTTER_BLOCKS);
    public static final Block BROWN_GOLDEN_CHANDELIER = registerBlock("brown_golden_chandelier", new ChandelierBlock(FabricBlockSettings.copy(Blocks.GOLD_BLOCK).luminance(ChandelierBlock.createLightLevelFromLitBlockState(12))), ModItemGroups.CLUTTER_BLOCKS);
    public static final Block RED_GOLDEN_CHANDELIER = registerBlock("red_golden_chandelier", new ChandelierBlock(FabricBlockSettings.copy(Blocks.GOLD_BLOCK).luminance(ChandelierBlock.createLightLevelFromLitBlockState(12))), ModItemGroups.CLUTTER_BLOCKS);
    public static final Block ORANGE_GOLDEN_CHANDELIER = registerBlock("orange_golden_chandelier", new ChandelierBlock(FabricBlockSettings.copy(Blocks.GOLD_BLOCK).luminance(ChandelierBlock.createLightLevelFromLitBlockState(12))), ModItemGroups.CLUTTER_BLOCKS);
    public static final Block YELLOW_GOLDEN_CHANDELIER = registerBlock("yellow_golden_chandelier", new ChandelierBlock(FabricBlockSettings.copy(Blocks.GOLD_BLOCK).luminance(ChandelierBlock.createLightLevelFromLitBlockState(12))), ModItemGroups.CLUTTER_BLOCKS);
    public static final Block LIME_GOLDEN_CHANDELIER = registerBlock("lime_golden_chandelier", new ChandelierBlock(FabricBlockSettings.copy(Blocks.GOLD_BLOCK).luminance(ChandelierBlock.createLightLevelFromLitBlockState(12))), ModItemGroups.CLUTTER_BLOCKS);
    public static final Block GREEN_GOLDEN_CHANDELIER = registerBlock("green_golden_chandelier", new ChandelierBlock(FabricBlockSettings.copy(Blocks.GOLD_BLOCK).luminance(ChandelierBlock.createLightLevelFromLitBlockState(12))), ModItemGroups.CLUTTER_BLOCKS);
    public static final Block CYAN_GOLDEN_CHANDELIER = registerBlock("cyan_golden_chandelier", new ChandelierBlock(FabricBlockSettings.copy(Blocks.GOLD_BLOCK).luminance(ChandelierBlock.createLightLevelFromLitBlockState(12))), ModItemGroups.CLUTTER_BLOCKS);
    public static final Block LIGHT_BLUE_GOLDEN_CHANDELIER = registerBlock("light_blue_golden_chandelier", new ChandelierBlock(FabricBlockSettings.copy(Blocks.GOLD_BLOCK).luminance(ChandelierBlock.createLightLevelFromLitBlockState(12))), ModItemGroups.CLUTTER_BLOCKS);
    public static final Block BLUE_GOLDEN_CHANDELIER = registerBlock("blue_golden_chandelier", new ChandelierBlock(FabricBlockSettings.copy(Blocks.GOLD_BLOCK).luminance(ChandelierBlock.createLightLevelFromLitBlockState(12))), ModItemGroups.CLUTTER_BLOCKS);
    public static final Block PURPLE_GOLDEN_CHANDELIER = registerBlock("purple_golden_chandelier", new ChandelierBlock(FabricBlockSettings.copy(Blocks.GOLD_BLOCK).luminance(ChandelierBlock.createLightLevelFromLitBlockState(12))), ModItemGroups.CLUTTER_BLOCKS);
    public static final Block MAGENTA_GOLDEN_CHANDELIER = registerBlock("magenta_golden_chandelier", new ChandelierBlock(FabricBlockSettings.copy(Blocks.GOLD_BLOCK).luminance(ChandelierBlock.createLightLevelFromLitBlockState(12))), ModItemGroups.CLUTTER_BLOCKS);
    public static final Block PINK_GOLDEN_CHANDELIER = registerBlock("pink_golden_chandelier", new ChandelierBlock(FabricBlockSettings.copy(Blocks.GOLD_BLOCK).luminance(ChandelierBlock.createLightLevelFromLitBlockState(12))), ModItemGroups.CLUTTER_BLOCKS);

    public static final Block SILVER_CHANDELIER = registerBlock("silver_chandelier", new ChandelierBlock( FabricBlockSettings.copy(ModBlocks.SILVER_BLOCK).luminance(ChandelierBlock.createLightLevelFromLitBlockState(12))), ModItemGroups.CLUTTER_BLOCKS);
    public static final Block WHITE_SILVER_CHANDELIER = registerBlock("white_silver_chandelier", new ChandelierBlock(FabricBlockSettings.copy(ModBlocks.SILVER_BLOCK).luminance(ChandelierBlock.createLightLevelFromLitBlockState(12))), ModItemGroups.CLUTTER_BLOCKS);
    public static final Block LIGHT_GRAY_SILVER_CHANDELIER = registerBlock("light_gray_silver_chandelier", new ChandelierBlock(FabricBlockSettings.copy(ModBlocks.SILVER_BLOCK).luminance(ChandelierBlock.createLightLevelFromLitBlockState(12))), ModItemGroups.CLUTTER_BLOCKS);
    public static final Block GRAY_SILVER_CHANDELIER = registerBlock("gray_silver_chandelier", new ChandelierBlock(FabricBlockSettings.copy(ModBlocks.SILVER_BLOCK).luminance(ChandelierBlock.createLightLevelFromLitBlockState(12))), ModItemGroups.CLUTTER_BLOCKS);
    public static final Block BLACK_SILVER_CHANDELIER = registerBlock("black_silver_chandelier", new ChandelierBlock(FabricBlockSettings.copy(ModBlocks.SILVER_BLOCK).luminance(ChandelierBlock.createLightLevelFromLitBlockState(12))), ModItemGroups.CLUTTER_BLOCKS);
    public static final Block BROWN_SILVER_CHANDELIER = registerBlock("brown_silver_chandelier", new ChandelierBlock(FabricBlockSettings.copy(ModBlocks.SILVER_BLOCK).luminance(ChandelierBlock.createLightLevelFromLitBlockState(12))), ModItemGroups.CLUTTER_BLOCKS);
    public static final Block RED_SILVER_CHANDELIER = registerBlock("red_silver_chandelier", new ChandelierBlock(FabricBlockSettings.copy(ModBlocks.SILVER_BLOCK).luminance(ChandelierBlock.createLightLevelFromLitBlockState(12))), ModItemGroups.CLUTTER_BLOCKS);
    public static final Block ORANGE_SILVER_CHANDELIER = registerBlock("orange_silver_chandelier", new ChandelierBlock(FabricBlockSettings.copy(ModBlocks.SILVER_BLOCK).luminance(ChandelierBlock.createLightLevelFromLitBlockState(12))), ModItemGroups.CLUTTER_BLOCKS);
    public static final Block YELLOW_SILVER_CHANDELIER = registerBlock("yellow_silver_chandelier", new ChandelierBlock(FabricBlockSettings.copy(ModBlocks.SILVER_BLOCK).luminance(ChandelierBlock.createLightLevelFromLitBlockState(12))), ModItemGroups.CLUTTER_BLOCKS);
    public static final Block LIME_SILVER_CHANDELIER = registerBlock("lime_silver_chandelier", new ChandelierBlock(FabricBlockSettings.copy(ModBlocks.SILVER_BLOCK).luminance(ChandelierBlock.createLightLevelFromLitBlockState(12))), ModItemGroups.CLUTTER_BLOCKS);
    public static final Block GREEN_SILVER_CHANDELIER = registerBlock("green_silver_chandelier", new ChandelierBlock(FabricBlockSettings.copy(ModBlocks.SILVER_BLOCK).luminance(ChandelierBlock.createLightLevelFromLitBlockState(12))), ModItemGroups.CLUTTER_BLOCKS);
    public static final Block CYAN_SILVER_CHANDELIER = registerBlock("cyan_silver_chandelier", new ChandelierBlock(FabricBlockSettings.copy(ModBlocks.SILVER_BLOCK).luminance(ChandelierBlock.createLightLevelFromLitBlockState(12))), ModItemGroups.CLUTTER_BLOCKS);
    public static final Block LIGHT_BLUE_SILVER_CHANDELIER = registerBlock("light_blue_silver_chandelier", new ChandelierBlock(FabricBlockSettings.copy(ModBlocks.SILVER_BLOCK).luminance(ChandelierBlock.createLightLevelFromLitBlockState(12))), ModItemGroups.CLUTTER_BLOCKS);
    public static final Block BLUE_SILVER_CHANDELIER = registerBlock("blue_silver_chandelier", new ChandelierBlock(FabricBlockSettings.copy(ModBlocks.SILVER_BLOCK).luminance(ChandelierBlock.createLightLevelFromLitBlockState(12))), ModItemGroups.CLUTTER_BLOCKS);
    public static final Block PURPLE_SILVER_CHANDELIER = registerBlock("purple_silver_chandelier", new ChandelierBlock(FabricBlockSettings.copy(ModBlocks.SILVER_BLOCK).luminance(ChandelierBlock.createLightLevelFromLitBlockState(12))), ModItemGroups.CLUTTER_BLOCKS);
    public static final Block MAGENTA_SILVER_CHANDELIER = registerBlock("magenta_silver_chandelier", new ChandelierBlock(FabricBlockSettings.copy(ModBlocks.SILVER_BLOCK).luminance(ChandelierBlock.createLightLevelFromLitBlockState(12))), ModItemGroups.CLUTTER_BLOCKS);
    public static final Block PINK_SILVER_CHANDELIER = registerBlock("pink_silver_chandelier", new ChandelierBlock(FabricBlockSettings.copy(ModBlocks.SILVER_BLOCK).luminance(ChandelierBlock.createLightLevelFromLitBlockState(12))), ModItemGroups.CLUTTER_BLOCKS);

    public static final Block COPPER_CANDELABRA = registerBlock("copper_candelabra", new OxidizableCandelabraBlock(Oxidizable.OxidationLevel.UNAFFECTED, FabricBlockSettings.copy(Blocks.COPPER_BLOCK).luminance(CandelabraBlock.createLightLevelFromLitBlockState(12))), ModItemGroups.CLUTTER_BLOCKS);
    public static final Block WHITE_COPPER_CANDELABRA = registerBlock("white_copper_candelabra", new OxidizableCandelabraBlock(Oxidizable.OxidationLevel.UNAFFECTED,FabricBlockSettings.copy(Blocks.COPPER_BLOCK).luminance(CandelabraBlock.createLightLevelFromLitBlockState(12))), ModItemGroups.CLUTTER_BLOCKS);
    public static final Block LIGHT_GRAY_COPPER_CANDELABRA = registerBlock("light_gray_copper_candelabra", new OxidizableCandelabraBlock(Oxidizable.OxidationLevel.UNAFFECTED,FabricBlockSettings.copy(Blocks.COPPER_BLOCK).luminance(CandelabraBlock.createLightLevelFromLitBlockState(12))), ModItemGroups.CLUTTER_BLOCKS);
    public static final Block GRAY_COPPER_CANDELABRA = registerBlock("gray_copper_candelabra", new OxidizableCandelabraBlock(Oxidizable.OxidationLevel.UNAFFECTED,FabricBlockSettings.copy(Blocks.COPPER_BLOCK).luminance(CandelabraBlock.createLightLevelFromLitBlockState(12))), ModItemGroups.CLUTTER_BLOCKS);
    public static final Block BLACK_COPPER_CANDELABRA = registerBlock("black_copper_candelabra", new OxidizableCandelabraBlock(Oxidizable.OxidationLevel.UNAFFECTED,FabricBlockSettings.copy(Blocks.COPPER_BLOCK).luminance(CandelabraBlock.createLightLevelFromLitBlockState(12))), ModItemGroups.CLUTTER_BLOCKS);
    public static final Block BROWN_COPPER_CANDELABRA = registerBlock("brown_copper_candelabra", new OxidizableCandelabraBlock(Oxidizable.OxidationLevel.UNAFFECTED,FabricBlockSettings.copy(Blocks.COPPER_BLOCK).luminance(CandelabraBlock.createLightLevelFromLitBlockState(12))), ModItemGroups.CLUTTER_BLOCKS);
    public static final Block RED_COPPER_CANDELABRA = registerBlock("red_copper_candelabra", new OxidizableCandelabraBlock(Oxidizable.OxidationLevel.UNAFFECTED,FabricBlockSettings.copy(Blocks.COPPER_BLOCK).luminance(CandelabraBlock.createLightLevelFromLitBlockState(12))), ModItemGroups.CLUTTER_BLOCKS);
    public static final Block ORANGE_COPPER_CANDELABRA = registerBlock("orange_copper_candelabra", new OxidizableCandelabraBlock(Oxidizable.OxidationLevel.UNAFFECTED,FabricBlockSettings.copy(Blocks.COPPER_BLOCK).luminance(CandelabraBlock.createLightLevelFromLitBlockState(12))), ModItemGroups.CLUTTER_BLOCKS);
    public static final Block YELLOW_COPPER_CANDELABRA = registerBlock("yellow_copper_candelabra", new OxidizableCandelabraBlock(Oxidizable.OxidationLevel.UNAFFECTED,FabricBlockSettings.copy(Blocks.COPPER_BLOCK).luminance(CandelabraBlock.createLightLevelFromLitBlockState(12))), ModItemGroups.CLUTTER_BLOCKS);
    public static final Block LIME_COPPER_CANDELABRA = registerBlock("lime_copper_candelabra", new OxidizableCandelabraBlock(Oxidizable.OxidationLevel.UNAFFECTED,FabricBlockSettings.copy(Blocks.COPPER_BLOCK).luminance(CandelabraBlock.createLightLevelFromLitBlockState(12))), ModItemGroups.CLUTTER_BLOCKS);
    public static final Block GREEN_COPPER_CANDELABRA = registerBlock("green_copper_candelabra", new OxidizableCandelabraBlock(Oxidizable.OxidationLevel.UNAFFECTED,FabricBlockSettings.copy(Blocks.COPPER_BLOCK).luminance(CandelabraBlock.createLightLevelFromLitBlockState(12))), ModItemGroups.CLUTTER_BLOCKS);
    public static final Block CYAN_COPPER_CANDELABRA = registerBlock("cyan_copper_candelabra", new OxidizableCandelabraBlock(Oxidizable.OxidationLevel.UNAFFECTED,FabricBlockSettings.copy(Blocks.COPPER_BLOCK).luminance(CandelabraBlock.createLightLevelFromLitBlockState(12))), ModItemGroups.CLUTTER_BLOCKS);
    public static final Block LIGHT_BLUE_COPPER_CANDELABRA = registerBlock("light_blue_copper_candelabra", new OxidizableCandelabraBlock(Oxidizable.OxidationLevel.UNAFFECTED,FabricBlockSettings.copy(Blocks.COPPER_BLOCK).luminance(CandelabraBlock.createLightLevelFromLitBlockState(12))), ModItemGroups.CLUTTER_BLOCKS);
    public static final Block BLUE_COPPER_CANDELABRA = registerBlock("blue_copper_candelabra", new OxidizableCandelabraBlock(Oxidizable.OxidationLevel.UNAFFECTED,FabricBlockSettings.copy(Blocks.COPPER_BLOCK).luminance(CandelabraBlock.createLightLevelFromLitBlockState(12))), ModItemGroups.CLUTTER_BLOCKS);
    public static final Block PURPLE_COPPER_CANDELABRA = registerBlock("purple_copper_candelabra", new OxidizableCandelabraBlock(Oxidizable.OxidationLevel.UNAFFECTED,FabricBlockSettings.copy(Blocks.COPPER_BLOCK).luminance(CandelabraBlock.createLightLevelFromLitBlockState(12))), ModItemGroups.CLUTTER_BLOCKS);
    public static final Block MAGENTA_COPPER_CANDELABRA = registerBlock("magenta_copper_candelabra", new OxidizableCandelabraBlock(Oxidizable.OxidationLevel.UNAFFECTED,FabricBlockSettings.copy(Blocks.COPPER_BLOCK).luminance(CandelabraBlock.createLightLevelFromLitBlockState(12))), ModItemGroups.CLUTTER_BLOCKS);
    public static final Block PINK_COPPER_CANDELABRA = registerBlock("pink_copper_candelabra", new OxidizableCandelabraBlock(Oxidizable.OxidationLevel.UNAFFECTED,FabricBlockSettings.copy(Blocks.COPPER_BLOCK).luminance(CandelabraBlock.createLightLevelFromLitBlockState(12))), ModItemGroups.CLUTTER_BLOCKS);

    public static final Block EXPOSED_COPPER_CANDELABRA = registerBlock("exposed_copper_candelabra", new OxidizableCandelabraBlock(Oxidizable.OxidationLevel.EXPOSED, FabricBlockSettings.copy(Blocks.EXPOSED_COPPER).luminance(CandelabraBlock.createLightLevelFromLitBlockState(12))), ModItemGroups.CLUTTER_BLOCKS);
    ...
    public static final Block OXIDIZED_COPPER_CANDELABRA = registerBlock("oxidized_copper_candelabra", new OxidizableCandelabraBlock(Oxidizable.OxidationLevel.OXIDIZED, FabricBlockSettings.copy(Blocks.WEATHERED_COPPER).luminance(CandelabraBlock.createLightLevelFromLitBlockState(12))), ModItemGroups.CLUTTER_BLOCKS);
    ...
    public static final Block WAXED_COPPER_CANDELABRA = registerBlock("waxed_copper_candelabra", new CandelabraBlock(FabricBlockSettings.copy(Blocks.COPPER_BLOCK).luminance(CandelabraBlock.createLightLevelFromLitBlockState(12))), ModItemGroups.CLUTTER_BLOCKS);
    public static final Block WAXED_WHITE_COPPER_CANDELABRA = registerBlock("waxed_white_copper_candelabra", new CandelabraBlock(FabricBlockSettings.copy(Blocks.COPPER_BLOCK).luminance(CandelabraBlock.createLightLevelFromLitBlockState(12))), ModItemGroups.CLUTTER_BLOCKS);
    public static final Block WAXED_LIGHT_GRAY_COPPER_CANDELABRA = registerBlock("waxed_light_gray_copper_candelabra", new CandelabraBlock(FabricBlockSettings.copy(Blocks.COPPER_BLOCK).luminance(CandelabraBlock.createLightLevelFromLitBlockState(12))), ModItemGroups.CLUTTER_BLOCKS);
    public static final Block WAXED_GRAY_COPPER_CANDELABRA = registerBlock("waxed_gray_copper_candelabra", new CandelabraBlock(FabricBlockSettings.copy(Blocks.COPPER_BLOCK).luminance(CandelabraBlock.createLightLevelFromLitBlockState(12))), ModItemGroups.CLUTTER_BLOCKS);
    public static final Block WAXED_BLACK_COPPER_CANDELABRA = registerBlock("waxed_black_copper_candelabra", new CandelabraBlock(FabricBlockSettings.copy(Blocks.COPPER_BLOCK).luminance(CandelabraBlock.createLightLevelFromLitBlockState(12))), ModItemGroups.CLUTTER_BLOCKS);
    public static final Block WAXED_BROWN_COPPER_CANDELABRA = registerBlock("waxed_brown_copper_candelabra", new CandelabraBlock(FabricBlockSettings.copy(Blocks.COPPER_BLOCK).luminance(CandelabraBlock.createLightLevelFromLitBlockState(12))), ModItemGroups.CLUTTER_BLOCKS);
    public static final Block WAXED_RED_COPPER_CANDELABRA = registerBlock("waxed_red_copper_candelabra", new CandelabraBlock(FabricBlockSettings.copy(Blocks.COPPER_BLOCK).luminance(CandelabraBlock.createLightLevelFromLitBlockState(12))), ModItemGroups.CLUTTER_BLOCKS);
    public static final Block WAXED_ORANGE_COPPER_CANDELABRA = registerBlock("waxed_orange_copper_candelabra", new CandelabraBlock(FabricBlockSettings.copy(Blocks.COPPER_BLOCK).luminance(CandelabraBlock.createLightLevelFromLitBlockState(12))), ModItemGroups.CLUTTER_BLOCKS);
    public static final Block WAXED_YELLOW_COPPER_CANDELABRA = registerBlock("waxed_yellow_copper_candelabra", new CandelabraBlock(FabricBlockSettings.copy(Blocks.COPPER_BLOCK).luminance(CandelabraBlock.createLightLevelFromLitBlockState(12))), ModItemGroups.CLUTTER_BLOCKS);
    public static final Block WAXED_LIME_COPPER_CANDELABRA = registerBlock("waxed_lime_copper_candelabra", new CandelabraBlock(FabricBlockSettings.copy(Blocks.COPPER_BLOCK).luminance(CandelabraBlock.createLightLevelFromLitBlockState(12))), ModItemGroups.CLUTTER_BLOCKS);
    public static final Block WAXED_GREEN_COPPER_CANDELABRA = registerBlock("waxed_green_copper_candelabra", new CandelabraBlock(FabricBlockSettings.copy(Blocks.COPPER_BLOCK).luminance(CandelabraBlock.createLightLevelFromLitBlockState(12))), ModItemGroups.CLUTTER_BLOCKS);
    public static final Block WAXED_CYAN_COPPER_CANDELABRA = registerBlock("waxed_cyan_copper_candelabra", new CandelabraBlock(FabricBlockSettings.copy(Blocks.COPPER_BLOCK).luminance(CandelabraBlock.createLightLevelFromLitBlockState(12))), ModItemGroups.CLUTTER_BLOCKS);
    public static final Block WAXED_LIGHT_BLUE_COPPER_CANDELABRA = registerBlock("waxed_light_blue_copper_candelabra", new CandelabraBlock(FabricBlockSettings.copy(Blocks.COPPER_BLOCK).luminance(CandelabraBlock.createLightLevelFromLitBlockState(12))), ModItemGroups.CLUTTER_BLOCKS);
    public static final Block WAXED_BLUE_COPPER_CANDELABRA = registerBlock("waxed_blue_copper_candelabra", new CandelabraBlock(FabricBlockSettings.copy(Blocks.COPPER_BLOCK).luminance(CandelabraBlock.createLightLevelFromLitBlockState(12))), ModItemGroups.CLUTTER_BLOCKS);
    public static final Block WAXED_PURPLE_COPPER_CANDELABRA = registerBlock("waxed_purple_copper_candelabra", new CandelabraBlock(FabricBlockSettings.copy(Blocks.COPPER_BLOCK).luminance(CandelabraBlock.createLightLevelFromLitBlockState(12))), ModItemGroups.CLUTTER_BLOCKS);
    public static final Block WAXED_MAGENTA_COPPER_CANDELABRA = registerBlock("waxed_magenta_copper_candelabra", new CandelabraBlock(FabricBlockSettings.copy(Blocks.COPPER_BLOCK).luminance(CandelabraBlock.createLightLevelFromLitBlockState(12))), ModItemGroups.CLUTTER_BLOCKS);
    public static final Block WAXED_PINK_COPPER_CANDELABRA = registerBlock("waxed_pink_copper_candelabra", new CandelabraBlock(FabricBlockSettings.copy(Blocks.COPPER_BLOCK).luminance(CandelabraBlock.createLightLevelFromLitBlockState(12))), ModItemGroups.CLUTTER_BLOCKS);

    public static final Block WAXED_EXPOSED_COPPER_CANDELABRA = registerBlock("waxed_exposed_copper_candelabra", new CandelabraBlock(FabricBlockSettings.copy(Blocks.COPPER_BLOCK).luminance(CandelabraBlock.createLightLevelFromLitBlockState(12))), ModItemGroups.CLUTTER_BLOCKS);
    public static final Block WAXED_EXPOSED_WHITE_COPPER_CANDELABRA = registerBlock("waxed_exposed_white_copper_candelabra", new CandelabraBlock(FabricBlockSettings.copy(Blocks.COPPER_BLOCK).luminance(CandelabraBlock.createLightLevelFromLitBlockState(12))), ModItemGroups.CLUTTER_BLOCKS);
    public static final Block WAXED_EXPOSED_LIGHT_GRAY_COPPER_CANDELABRA = registerBlock("waxed_exposed_light_gray_copper_candelabra", new CandelabraBlock(FabricBlockSettings.copy(Blocks.COPPER_BLOCK).luminance(CandelabraBlock.createLightLevelFromLitBlockState(12))), ModItemGroups.CLUTTER_BLOCKS);
    public static final Block WAXED_EXPOSED_GRAY_COPPER_CANDELABRA = registerBlock("waxed_exposed_gray_copper_candelabra", new CandelabraBlock(FabricBlockSettings.copy(Blocks.COPPER_BLOCK).luminance(CandelabraBlock.createLightLevelFromLitBlockState(12))), ModItemGroups.CLUTTER_BLOCKS);
    public static final Block WAXED_EXPOSED_BLACK_COPPER_CANDELABRA = registerBlock("waxed_exposed_black_copper_candelabra", new CandelabraBlock(FabricBlockSettings.copy(Blocks.COPPER_BLOCK).luminance(CandelabraBlock.createLightLevelFromLitBlockState(12))), ModItemGroups.CLUTTER_BLOCKS);
    public static final Block WAXED_EXPOSED_BROWN_COPPER_CANDELABRA = registerBlock("waxed_exposed_brown_copper_candelabra", new CandelabraBlock(FabricBlockSettings.copy(Blocks.COPPER_BLOCK).luminance(CandelabraBlock.createLightLevelFromLitBlockState(12))), ModItemGroups.CLUTTER_BLOCKS);
    public static final Block WAXED_EXPOSED_RED_COPPER_CANDELABRA = registerBlock("waxed_exposed_red_copper_candelabra", new CandelabraBlock(FabricBlockSettings.copy(Blocks.COPPER_BLOCK).luminance(CandelabraBlock.createLightLevelFromLitBlockState(12))), ModItemGroups.CLUTTER_BLOCKS);
    public static final Block WAXED_EXPOSED_ORANGE_COPPER_CANDELABRA = registerBlock("waxed_exposed_orange_copper_candelabra", new CandelabraBlock(FabricBlockSettings.copy(Blocks.COPPER_BLOCK).luminance(CandelabraBlock.createLightLevelFromLitBlockState(12))), ModItemGroups.CLUTTER_BLOCKS);
    public static final Block WAXED_EXPOSED_YELLOW_COPPER_CANDELABRA = registerBlock("waxed_exposed_yellow_copper_candelabra", new CandelabraBlock(FabricBlockSettings.copy(Blocks.COPPER_BLOCK).luminance(CandelabraBlock.createLightLevelFromLitBlockState(12))), ModItemGroups.CLUTTER_BLOCKS);
    public static final Block WAXED_EXPOSED_LIME_COPPER_CANDELABRA = registerBlock("waxed_exposed_lime_copper_candelabra", new CandelabraBlock(FabricBlockSettings.copy(Blocks.COPPER_BLOCK).luminance(CandelabraBlock.createLightLevelFromLitBlockState(12))), ModItemGroups.CLUTTER_BLOCKS);
    public static final Block WAXED_EXPOSED_GREEN_COPPER_CANDELABRA = registerBlock("waxed_exposed_green_copper_candelabra", new CandelabraBlock(FabricBlockSettings.copy(Blocks.COPPER_BLOCK).luminance(CandelabraBlock.createLightLevelFromLitBlockState(12))), ModItemGroups.CLUTTER_BLOCKS);
    public static final Block WAXED_EXPOSED_CYAN_COPPER_CANDELABRA = registerBlock("waxed_exposed_cyan_copper_candelabra", new CandelabraBlock(FabricBlockSettings.copy(Blocks.COPPER_BLOCK).luminance(CandelabraBlock.createLightLevelFromLitBlockState(12))), ModItemGroups.CLUTTER_BLOCKS);
    public static final Block WAXED_EXPOSED_LIGHT_BLUE_COPPER_CANDELABRA = registerBlock("waxed_exposed_light_blue_copper_candelabra", new CandelabraBlock(FabricBlockSettings.copy(Blocks.COPPER_BLOCK).luminance(CandelabraBlock.createLightLevelFromLitBlockState(12))), ModItemGroups.CLUTTER_BLOCKS);
    public static final Block WAXED_EXPOSED_BLUE_COPPER_CANDELABRA = registerBlock("waxed_exposed_blue_copper_candelabra", new CandelabraBlock(FabricBlockSettings.copy(Blocks.COPPER_BLOCK).luminance(CandelabraBlock.createLightLevelFromLitBlockState(12))), ModItemGroups.CLUTTER_BLOCKS);
    public static final Block WAXED_EXPOSED_PURPLE_COPPER_CANDELABRA = registerBlock("waxed_exposed_purple_copper_candelabra", new CandelabraBlock(FabricBlockSettings.copy(Blocks.COPPER_BLOCK).luminance(CandelabraBlock.createLightLevelFromLitBlockState(12))), ModItemGroups.CLUTTER_BLOCKS);
    public static final Block WAXED_EXPOSED_MAGENTA_COPPER_CANDELABRA = registerBlock("waxed_exposed_magenta_copper_candelabra", new CandelabraBlock(FabricBlockSettings.copy(Blocks.COPPER_BLOCK).luminance(CandelabraBlock.createLightLevelFromLitBlockState(12))), ModItemGroups.CLUTTER_BLOCKS);
    public static final Block WAXED_EXPOSED_PINK_COPPER_CANDELABRA = registerBlock("waxed_exposed_pink_copper_candelabra", new CandelabraBlock(FabricBlockSettings.copy(Blocks.COPPER_BLOCK).luminance(CandelabraBlock.createLightLevelFromLitBlockState(12))), ModItemGroups.CLUTTER_BLOCKS);

    public static final Block WAXED_WEATHERED_COPPER_CANDELABRA = registerBlock("waxed_weathered_copper_candelabra", new CandelabraBlock(FabricBlockSettings.copy(Blocks.COPPER_BLOCK).luminance(CandelabraBlock.createLightLevelFromLitBlockState(12))), ModItemGroups.CLUTTER_BLOCKS);
    public static final Block WAXED_WEATHERED_WHITE_COPPER_CANDELABRA = registerBlock("waxed_weathered_white_copper_candelabra", new CandelabraBlock(FabricBlockSettings.copy(Blocks.COPPER_BLOCK).luminance(CandelabraBlock.createLightLevelFromLitBlockState(12))), ModItemGroups.CLUTTER_BLOCKS);
    public static final Block WAXED_WEATHERED_LIGHT_GRAY_COPPER_CANDELABRA = registerBlock("waxed_weathered_light_gray_copper_candelabra", new CandelabraBlock(FabricBlockSettings.copy(Blocks.COPPER_BLOCK).luminance(CandelabraBlock.createLightLevelFromLitBlockState(12))), ModItemGroups.CLUTTER_BLOCKS);
    public static final Block WAXED_WEATHERED_GRAY_COPPER_CANDELABRA = registerBlock("waxed_weathered_gray_copper_candelabra", new CandelabraBlock(FabricBlockSettings.copy(Blocks.COPPER_BLOCK).luminance(CandelabraBlock.createLightLevelFromLitBlockState(12))), ModItemGroups.CLUTTER_BLOCKS);
    public static final Block WAXED_WEATHERED_BLACK_COPPER_CANDELABRA = registerBlock("waxed_weathered_black_copper_candelabra", new CandelabraBlock(FabricBlockSettings.copy(Blocks.COPPER_BLOCK).luminance(CandelabraBlock.createLightLevelFromLitBlockState(12))), ModItemGroups.CLUTTER_BLOCKS);
    public static final Block WAXED_WEATHERED_BROWN_COPPER_CANDELABRA = registerBlock("waxed_weathered_brown_copper_candelabra", new CandelabraBlock(FabricBlockSettings.copy(Blocks.COPPER_BLOCK).luminance(CandelabraBlock.createLightLevelFromLitBlockState(12))), ModItemGroups.CLUTTER_BLOCKS);
    public static final Block WAXED_WEATHERED_RED_COPPER_CANDELABRA = registerBlock("waxed_weathered_red_copper_candelabra", new CandelabraBlock(FabricBlockSettings.copy(Blocks.COPPER_BLOCK).luminance(CandelabraBlock.createLightLevelFromLitBlockState(12))), ModItemGroups.CLUTTER_BLOCKS);
    public static final Block WAXED_WEATHERED_ORANGE_COPPER_CANDELABRA = registerBlock("waxed_weathered_orange_copper_candelabra", new CandelabraBlock(FabricBlockSettings.copy(Blocks.COPPER_BLOCK).luminance(CandelabraBlock.createLightLevelFromLitBlockState(12))), ModItemGroups.CLUTTER_BLOCKS);
    public static final Block WAXED_WEATHERED_YELLOW_COPPER_CANDELABRA = registerBlock("waxed_weathered_yellow_copper_candelabra", new CandelabraBlock(FabricBlockSettings.copy(Blocks.COPPER_BLOCK).luminance(CandelabraBlock.createLightLevelFromLitBlockState(12))), ModItemGroups.CLUTTER_BLOCKS);
    public static final Block WAXED_WEATHERED_LIME_COPPER_CANDELABRA = registerBlock("waxed_weathered_lime_copper_candelabra", new CandelabraBlock(FabricBlockSettings.copy(Blocks.COPPER_BLOCK).luminance(CandelabraBlock.createLightLevelFromLitBlockState(12))), ModItemGroups.CLUTTER_BLOCKS);
    public static final Block WAXED_WEATHERED_GREEN_COPPER_CANDELABRA = registerBlock("waxed_weathered_green_copper_candelabra", new CandelabraBlock(FabricBlockSettings.copy(Blocks.COPPER_BLOCK).luminance(CandelabraBlock.createLightLevelFromLitBlockState(12))), ModItemGroups.CLUTTER_BLOCKS);
    public static final Block WAXED_WEATHERED_CYAN_COPPER_CANDELABRA = registerBlock("waxed_weathered_cyan_copper_candelabra", new CandelabraBlock(FabricBlockSettings.copy(Blocks.COPPER_BLOCK).luminance(CandelabraBlock.createLightLevelFromLitBlockState(12))), ModItemGroups.CLUTTER_BLOCKS);
    public static final Block WAXED_WEATHERED_LIGHT_BLUE_COPPER_CANDELABRA = registerBlock("waxed_weathered_light_blue_copper_candelabra", new CandelabraBlock(FabricBlockSettings.copy(Blocks.COPPER_BLOCK).luminance(CandelabraBlock.createLightLevelFromLitBlockState(12))), ModItemGroups.CLUTTER_BLOCKS);
    public static final Block WAXED_WEATHERED_BLUE_COPPER_CANDELABRA = registerBlock("waxed_weathered_blue_copper_candelabra", new CandelabraBlock(FabricBlockSettings.copy(Blocks.COPPER_BLOCK).luminance(CandelabraBlock.createLightLevelFromLitBlockState(12))), ModItemGroups.CLUTTER_BLOCKS);
    public static final Block WAXED_WEATHERED_PURPLE_COPPER_CANDELABRA = registerBlock("waxed_weathered_purple_copper_candelabra", new CandelabraBlock(FabricBlockSettings.copy(Blocks.COPPER_BLOCK).luminance(CandelabraBlock.createLightLevelFromLitBlockState(12))), ModItemGroups.CLUTTER_BLOCKS);
    public static final Block WAXED_WEATHERED_MAGENTA_COPPER_CANDELABRA = registerBlock("waxed_weathered_magenta_copper_candelabra", new CandelabraBlock(FabricBlockSettings.copy(Blocks.COPPER_BLOCK).luminance(CandelabraBlock.createLightLevelFromLitBlockState(12))), ModItemGroups.CLUTTER_BLOCKS);
    public static final Block WAXED_WEATHERED_PINK_COPPER_CANDELABRA = registerBlock("waxed_weathered_pink_copper_candelabra", new CandelabraBlock(FabricBlockSettings.copy(Blocks.COPPER_BLOCK).luminance(CandelabraBlock.createLightLevelFromLitBlockState(12))), ModItemGroups.CLUTTER_BLOCKS);

    public static final Block WAXED_OXIDIZED_COPPER_CANDELABRA = registerBlock("waxed_oxidized_copper_candelabra", new CandelabraBlock(FabricBlockSettings.copy(Blocks.COPPER_BLOCK).luminance(CandelabraBlock.createLightLevelFromLitBlockState(12))), ModItemGroups.CLUTTER_BLOCKS);
    public static final Block WAXED_OXIDIZED_WHITE_COPPER_CANDELABRA = registerBlock("waxed_oxidized_white_copper_candelabra", new CandelabraBlock(FabricBlockSettings.copy(Blocks.COPPER_BLOCK).luminance(CandelabraBlock.createLightLevelFromLitBlockState(12))), ModItemGroups.CLUTTER_BLOCKS);
    public static final Block WAXED_OXIDIZED_LIGHT_GRAY_COPPER_CANDELABRA = registerBlock("waxed_oxidized_light_gray_copper_candelabra", new CandelabraBlock(FabricBlockSettings.copy(Blocks.COPPER_BLOCK).luminance(CandelabraBlock.createLightLevelFromLitBlockState(12))), ModItemGroups.CLUTTER_BLOCKS);
    public static final Block WAXED_OXIDIZED_GRAY_COPPER_CANDELABRA = registerBlock("waxed_oxidized_gray_copper_candelabra", new CandelabraBlock(FabricBlockSettings.copy(Blocks.COPPER_BLOCK).luminance(CandelabraBlock.createLightLevelFromLitBlockState(12))), ModItemGroups.CLUTTER_BLOCKS);
    public static final Block WAXED_OXIDIZED_BLACK_COPPER_CANDELABRA = registerBlock("waxed_oxidized_black_copper_candelabra", new CandelabraBlock(FabricBlockSettings.copy(Blocks.COPPER_BLOCK).luminance(CandelabraBlock.createLightLevelFromLitBlockState(12))), ModItemGroups.CLUTTER_BLOCKS);
    public static final Block WAXED_OXIDIZED_BROWN_COPPER_CANDELABRA = registerBlock("waxed_oxidized_brown_copper_candelabra", new CandelabraBlock(FabricBlockSettings.copy(Blocks.COPPER_BLOCK).luminance(CandelabraBlock.createLightLevelFromLitBlockState(12))), ModItemGroups.CLUTTER_BLOCKS);
    public static final Block WAXED_OXIDIZED_RED_COPPER_CANDELABRA = registerBlock("waxed_oxidized_red_copper_candelabra", new CandelabraBlock(FabricBlockSettings.copy(Blocks.COPPER_BLOCK).luminance(CandelabraBlock.createLightLevelFromLitBlockState(12))), ModItemGroups.CLUTTER_BLOCKS);
    public static final Block WAXED_OXIDIZED_ORANGE_COPPER_CANDELABRA = registerBlock("waxed_oxidized_orange_copper_candelabra", new CandelabraBlock(FabricBlockSettings.copy(Blocks.COPPER_BLOCK).luminance(CandelabraBlock.createLightLevelFromLitBlockState(12))), ModItemGroups.CLUTTER_BLOCKS);
    public static final Block WAXED_OXIDIZED_YELLOW_COPPER_CANDELABRA = registerBlock("waxed_oxidized_yellow_copper_candelabra", new CandelabraBlock(FabricBlockSettings.copy(Blocks.COPPER_BLOCK).luminance(CandelabraBlock.createLightLevelFromLitBlockState(12))), ModItemGroups.CLUTTER_BLOCKS);
    public static final Block WAXED_OXIDIZED_LIME_COPPER_CANDELABRA = registerBlock("waxed_oxidized_lime_copper_candelabra", new CandelabraBlock(FabricBlockSettings.copy(Blocks.COPPER_BLOCK).luminance(CandelabraBlock.createLightLevelFromLitBlockState(12))), ModItemGroups.CLUTTER_BLOCKS);
    public static final Block WAXED_OXIDIZED_GREEN_COPPER_CANDELABRA = registerBlock("waxed_oxidized_green_copper_candelabra", new CandelabraBlock(FabricBlockSettings.copy(Blocks.COPPER_BLOCK).luminance(CandelabraBlock.createLightLevelFromLitBlockState(12))), ModItemGroups.CLUTTER_BLOCKS);
    public static final Block WAXED_OXIDIZED_CYAN_COPPER_CANDELABRA = registerBlock("waxed_oxidized_cyan_copper_candelabra", new CandelabraBlock(FabricBlockSettings.copy(Blocks.COPPER_BLOCK).luminance(CandelabraBlock.createLightLevelFromLitBlockState(12))), ModItemGroups.CLUTTER_BLOCKS);
    public static final Block WAXED_OXIDIZED_LIGHT_BLUE_COPPER_CANDELABRA = registerBlock("waxed_oxidized_light_blue_copper_candelabra", new CandelabraBlock(FabricBlockSettings.copy(Blocks.COPPER_BLOCK).luminance(CandelabraBlock.createLightLevelFromLitBlockState(12))), ModItemGroups.CLUTTER_BLOCKS);
    public static final Block WAXED_OXIDIZED_BLUE_COPPER_CANDELABRA = registerBlock("waxed_oxidized_blue_copper_candelabra", new CandelabraBlock(FabricBlockSettings.copy(Blocks.COPPER_BLOCK).luminance(CandelabraBlock.createLightLevelFromLitBlockState(12))), ModItemGroups.CLUTTER_BLOCKS);
    public static final Block WAXED_OXIDIZED_PURPLE_COPPER_CANDELABRA = registerBlock("waxed_oxidized_purple_copper_candelabra", new CandelabraBlock(FabricBlockSettings.copy(Blocks.COPPER_BLOCK).luminance(CandelabraBlock.createLightLevelFromLitBlockState(12))), ModItemGroups.CLUTTER_BLOCKS);
    public static final Block WAXED_OXIDIZED_MAGENTA_COPPER_CANDELABRA = registerBlock("waxed_oxidized_magenta_copper_candelabra", new CandelabraBlock(FabricBlockSettings.copy(Blocks.COPPER_BLOCK).luminance(CandelabraBlock.createLightLevelFromLitBlockState(12))), ModItemGroups.CLUTTER_BLOCKS);
    public static final Block WAXED_OXIDIZED_PINK_COPPER_CANDELABRA = registerBlock("waxed_oxidized_pink_copper_candelabra", new CandelabraBlock(FabricBlockSettings.copy(Blocks.COPPER_BLOCK).luminance(CandelabraBlock.createLightLevelFromLitBlockState(12))), ModItemGroups.CLUTTER_BLOCKS);

    public static final Block GOLDEN_CANDELABRA = registerBlock("golden_candelabra", new CandelabraBlock( FabricBlockSettings.copy(Blocks.GOLD_BLOCK).luminance(CandelabraBlock.createLightLevelFromLitBlockState(12))), ModItemGroups.CLUTTER_BLOCKS);
    public static final Block WHITE_GOLDEN_CANDELABRA = registerBlock("white_golden_candelabra", new CandelabraBlock(FabricBlockSettings.copy(Blocks.GOLD_BLOCK).luminance(CandelabraBlock.createLightLevelFromLitBlockState(12))), ModItemGroups.CLUTTER_BLOCKS);
    public static final Block LIGHT_GRAY_GOLDEN_CANDELABRA = registerBlock("light_gray_golden_candelabra", new CandelabraBlock(FabricBlockSettings.copy(Blocks.GOLD_BLOCK).luminance(CandelabraBlock.createLightLevelFromLitBlockState(12))), ModItemGroups.CLUTTER_BLOCKS);
    public static final Block GRAY_GOLDEN_CANDELABRA = registerBlock("gray_golden_candelabra", new CandelabraBlock(FabricBlockSettings.copy(Blocks.GOLD_BLOCK).luminance(CandelabraBlock.createLightLevelFromLitBlockState(12))), ModItemGroups.CLUTTER_BLOCKS);
    public static final Block BLACK_GOLDEN_CANDELABRA = registerBlock("black_golden_candelabra", new CandelabraBlock(FabricBlockSettings.copy(Blocks.GOLD_BLOCK).luminance(CandelabraBlock.createLightLevelFromLitBlockState(12))), ModItemGroups.CLUTTER_BLOCKS);
    public static final Block BROWN_GOLDEN_CANDELABRA = registerBlock("brown_golden_candelabra", new CandelabraBlock(FabricBlockSettings.copy(Blocks.GOLD_BLOCK).luminance(CandelabraBlock.createLightLevelFromLitBlockState(12))), ModItemGroups.CLUTTER_BLOCKS);
    public static final Block RED_GOLDEN_CANDELABRA = registerBlock("red_golden_candelabra", new CandelabraBlock(FabricBlockSettings.copy(Blocks.GOLD_BLOCK).luminance(CandelabraBlock.createLightLevelFromLitBlockState(12))), ModItemGroups.CLUTTER_BLOCKS);
    public static final Block ORANGE_GOLDEN_CANDELABRA = registerBlock("orange_golden_candelabra", new CandelabraBlock(FabricBlockSettings.copy(Blocks.GOLD_BLOCK).luminance(CandelabraBlock.createLightLevelFromLitBlockState(12))), ModItemGroups.CLUTTER_BLOCKS);
    public static final Block YELLOW_GOLDEN_CANDELABRA = registerBlock("yellow_golden_candelabra", new CandelabraBlock(FabricBlockSettings.copy(Blocks.GOLD_BLOCK).luminance(CandelabraBlock.createLightLevelFromLitBlockState(12))), ModItemGroups.CLUTTER_BLOCKS);
    public static final Block LIME_GOLDEN_CANDELABRA = registerBlock("lime_golden_candelabra", new CandelabraBlock(FabricBlockSettings.copy(Blocks.GOLD_BLOCK).luminance(CandelabraBlock.createLightLevelFromLitBlockState(12))), ModItemGroups.CLUTTER_BLOCKS);
    public static final Block GREEN_GOLDEN_CANDELABRA = registerBlock("green_golden_candelabra", new CandelabraBlock(FabricBlockSettings.copy(Blocks.GOLD_BLOCK).luminance(CandelabraBlock.createLightLevelFromLitBlockState(12))), ModItemGroups.CLUTTER_BLOCKS);
    public static final Block CYAN_GOLDEN_CANDELABRA = registerBlock("cyan_golden_candelabra", new CandelabraBlock(FabricBlockSettings.copy(Blocks.GOLD_BLOCK).luminance(CandelabraBlock.createLightLevelFromLitBlockState(12))), ModItemGroups.CLUTTER_BLOCKS);
    public static final Block LIGHT_BLUE_GOLDEN_CANDELABRA = registerBlock("light_blue_golden_candelabra", new CandelabraBlock(FabricBlockSettings.copy(Blocks.GOLD_BLOCK).luminance(CandelabraBlock.createLightLevelFromLitBlockState(12))), ModItemGroups.CLUTTER_BLOCKS);
    public static final Block BLUE_GOLDEN_CANDELABRA = registerBlock("blue_golden_candelabra", new CandelabraBlock(FabricBlockSettings.copy(Blocks.GOLD_BLOCK).luminance(CandelabraBlock.createLightLevelFromLitBlockState(12))), ModItemGroups.CLUTTER_BLOCKS);
    public static final Block PURPLE_GOLDEN_CANDELABRA = registerBlock("purple_golden_candelabra", new CandelabraBlock(FabricBlockSettings.copy(Blocks.GOLD_BLOCK).luminance(CandelabraBlock.createLightLevelFromLitBlockState(12))), ModItemGroups.CLUTTER_BLOCKS);
    public static final Block MAGENTA_GOLDEN_CANDELABRA = registerBlock("magenta_golden_candelabra", new CandelabraBlock(FabricBlockSettings.copy(Blocks.GOLD_BLOCK).luminance(CandelabraBlock.createLightLevelFromLitBlockState(12))), ModItemGroups.CLUTTER_BLOCKS);
    public static final Block PINK_GOLDEN_CANDELABRA = registerBlock("pink_golden_candelabra", new CandelabraBlock(FabricBlockSettings.copy(Blocks.GOLD_BLOCK).luminance(CandelabraBlock.createLightLevelFromLitBlockState(12))), ModItemGroups.CLUTTER_BLOCKS);

    public static final Block SILVER_CANDELABRA = registerBlock("silver_candelabra", new CandelabraBlock( FabricBlockSettings.copy(ModBlocks.SILVER_BLOCK).luminance(CandelabraBlock.createLightLevelFromLitBlockState(12))), ModItemGroups.CLUTTER_BLOCKS);
    public static final Block WHITE_SILVER_CANDELABRA = registerBlock("white_silver_candelabra", new CandelabraBlock(FabricBlockSettings.copy(ModBlocks.SILVER_BLOCK).luminance(CandelabraBlock.createLightLevelFromLitBlockState(12))), ModItemGroups.CLUTTER_BLOCKS);
    public static final Block LIGHT_GRAY_SILVER_CANDELABRA = registerBlock("light_gray_silver_candelabra", new CandelabraBlock(FabricBlockSettings.copy(ModBlocks.SILVER_BLOCK).luminance(CandelabraBlock.createLightLevelFromLitBlockState(12))), ModItemGroups.CLUTTER_BLOCKS);
    public static final Block GRAY_SILVER_CANDELABRA = registerBlock("gray_silver_candelabra", new CandelabraBlock(FabricBlockSettings.copy(ModBlocks.SILVER_BLOCK).luminance(CandelabraBlock.createLightLevelFromLitBlockState(12))), ModItemGroups.CLUTTER_BLOCKS);
    public static final Block BLACK_SILVER_CANDELABRA = registerBlock("black_silver_candelabra", new CandelabraBlock(FabricBlockSettings.copy(ModBlocks.SILVER_BLOCK).luminance(CandelabraBlock.createLightLevelFromLitBlockState(12))), ModItemGroups.CLUTTER_BLOCKS);
    public static final Block BROWN_SILVER_CANDELABRA = registerBlock("brown_silver_candelabra", new CandelabraBlock(FabricBlockSettings.copy(ModBlocks.SILVER_BLOCK).luminance(CandelabraBlock.createLightLevelFromLitBlockState(12))), ModItemGroups.CLUTTER_BLOCKS);
    public static final Block RED_SILVER_CANDELABRA = registerBlock("red_silver_candelabra", new CandelabraBlock(FabricBlockSettings.copy(ModBlocks.SILVER_BLOCK).luminance(CandelabraBlock.createLightLevelFromLitBlockState(12))), ModItemGroups.CLUTTER_BLOCKS);
    public static final Block ORANGE_SILVER_CANDELABRA = registerBlock("orange_silver_candelabra", new CandelabraBlock(FabricBlockSettings.copy(ModBlocks.SILVER_BLOCK).luminance(CandelabraBlock.createLightLevelFromLitBlockState(12))), ModItemGroups.CLUTTER_BLOCKS);
    public static final Block YELLOW_SILVER_CANDELABRA = registerBlock("yellow_silver_candelabra", new CandelabraBlock(FabricBlockSettings.copy(ModBlocks.SILVER_BLOCK).luminance(CandelabraBlock.createLightLevelFromLitBlockState(12))), ModItemGroups.CLUTTER_BLOCKS);
    public static final Block LIME_SILVER_CANDELABRA = registerBlock("lime_silver_candelabra", new CandelabraBlock(FabricBlockSettings.copy(ModBlocks.SILVER_BLOCK).luminance(CandelabraBlock.createLightLevelFromLitBlockState(12))), ModItemGroups.CLUTTER_BLOCKS);
    public static final Block GREEN_SILVER_CANDELABRA = registerBlock("green_silver_candelabra", new CandelabraBlock(FabricBlockSettings.copy(ModBlocks.SILVER_BLOCK).luminance(CandelabraBlock.createLightLevelFromLitBlockState(12))), ModItemGroups.CLUTTER_BLOCKS);
    public static final Block CYAN_SILVER_CANDELABRA = registerBlock("cyan_silver_candelabra", new CandelabraBlock(FabricBlockSettings.copy(ModBlocks.SILVER_BLOCK).luminance(CandelabraBlock.createLightLevelFromLitBlockState(12))), ModItemGroups.CLUTTER_BLOCKS);
    public static final Block LIGHT_BLUE_SILVER_CANDELABRA = registerBlock("light_blue_silver_candelabra", new CandelabraBlock(FabricBlockSettings.copy(ModBlocks.SILVER_BLOCK).luminance(CandelabraBlock.createLightLevelFromLitBlockState(12))), ModItemGroups.CLUTTER_BLOCKS);
    public static final Block BLUE_SILVER_CANDELABRA = registerBlock("blue_silver_candelabra", new CandelabraBlock(FabricBlockSettings.copy(ModBlocks.SILVER_BLOCK).luminance(CandelabraBlock.createLightLevelFromLitBlockState(12))), ModItemGroups.CLUTTER_BLOCKS);
    public static final Block PURPLE_SILVER_CANDELABRA = registerBlock("purple_silver_candelabra", new CandelabraBlock(FabricBlockSettings.copy(ModBlocks.SILVER_BLOCK).luminance(CandelabraBlock.createLightLevelFromLitBlockState(12))), ModItemGroups.CLUTTER_BLOCKS);
    public static final Block MAGENTA_SILVER_CANDELABRA = registerBlock("magenta_silver_candelabra", new CandelabraBlock(FabricBlockSettings.copy(ModBlocks.SILVER_BLOCK).luminance(CandelabraBlock.createLightLevelFromLitBlockState(12))), ModItemGroups.CLUTTER_BLOCKS);
    public static final Block PINK_SILVER_CANDELABRA = registerBlock("pink_silver_candelabra", new CandelabraBlock(FabricBlockSettings.copy(ModBlocks.SILVER_BLOCK).luminance(CandelabraBlock.createLightLevelFromLitBlockState(12))), ModItemGroups.CLUTTER_BLOCKS);

    public static final Block IRON_CANDELABRA = registerBlock("iron_candelabra", new CandelabraBlock( FabricBlockSettings.copy(Blocks.IRON_BLOCK).luminance(CandelabraBlock.createLightLevelFromLitBlockState(12))), ModItemGroups.CLUTTER_BLOCKS);
    public static final Block WHITE_IRON_CANDELABRA = registerBlock("white_iron_candelabra", new CandelabraBlock(FabricBlockSettings.copy(Blocks.IRON_BLOCK).luminance(CandelabraBlock.createLightLevelFromLitBlockState(12))), ModItemGroups.CLUTTER_BLOCKS);
    public static final Block LIGHT_GRAY_IRON_CANDELABRA = registerBlock("light_gray_iron_candelabra", new CandelabraBlock(FabricBlockSettings.copy(Blocks.IRON_BLOCK).luminance(CandelabraBlock.createLightLevelFromLitBlockState(12))), ModItemGroups.CLUTTER_BLOCKS);
    public static final Block GRAY_IRON_CANDELABRA = registerBlock("gray_iron_candelabra", new CandelabraBlock(FabricBlockSettings.copy(Blocks.IRON_BLOCK).luminance(CandelabraBlock.createLightLevelFromLitBlockState(12))), ModItemGroups.CLUTTER_BLOCKS);
    public static final Block BLACK_IRON_CANDELABRA = registerBlock("black_iron_candelabra", new CandelabraBlock(FabricBlockSettings.copy(Blocks.IRON_BLOCK).luminance(CandelabraBlock.createLightLevelFromLitBlockState(12))), ModItemGroups.CLUTTER_BLOCKS);
    public static final Block BROWN_IRON_CANDELABRA = registerBlock("brown_iron_candelabra", new CandelabraBlock(FabricBlockSettings.copy(Blocks.IRON_BLOCK).luminance(CandelabraBlock.createLightLevelFromLitBlockState(12))), ModItemGroups.CLUTTER_BLOCKS);
    public static final Block RED_IRON_CANDELABRA = registerBlock("red_iron_candelabra", new CandelabraBlock(FabricBlockSettings.copy(Blocks.IRON_BLOCK).luminance(CandelabraBlock.createLightLevelFromLitBlockState(12))), ModItemGroups.CLUTTER_BLOCKS);
    public static final Block ORANGE_IRON_CANDELABRA = registerBlock("orange_iron_candelabra", new CandelabraBlock(FabricBlockSettings.copy(Blocks.IRON_BLOCK).luminance(CandelabraBlock.createLightLevelFromLitBlockState(12))), ModItemGroups.CLUTTER_BLOCKS);
    public static final Block YELLOW_IRON_CANDELABRA = registerBlock("yellow_iron_candelabra", new CandelabraBlock(FabricBlockSettings.copy(Blocks.IRON_BLOCK).luminance(CandelabraBlock.createLightLevelFromLitBlockState(12))), ModItemGroups.CLUTTER_BLOCKS);
    public static final Block LIME_IRON_CANDELABRA = registerBlock("lime_iron_candelabra", new CandelabraBlock(FabricBlockSettings.copy(Blocks.IRON_BLOCK).luminance(CandelabraBlock.createLightLevelFromLitBlockState(12))), ModItemGroups.CLUTTER_BLOCKS);
    public static final Block GREEN_IRON_CANDELABRA = registerBlock("green_iron_candelabra", new CandelabraBlock(FabricBlockSettings.copy(Blocks.IRON_BLOCK).luminance(CandelabraBlock.createLightLevelFromLitBlockState(12))), ModItemGroups.CLUTTER_BLOCKS);
    public static final Block CYAN_IRON_CANDELABRA = registerBlock("cyan_iron_candelabra", new CandelabraBlock(FabricBlockSettings.copy(Blocks.IRON_BLOCK).luminance(CandelabraBlock.createLightLevelFromLitBlockState(12))), ModItemGroups.CLUTTER_BLOCKS);
    public static final Block LIGHT_BLUE_IRON_CANDELABRA = registerBlock("light_blue_iron_candelabra", new CandelabraBlock(FabricBlockSettings.copy(Blocks.IRON_BLOCK).luminance(CandelabraBlock.createLightLevelFromLitBlockState(12))), ModItemGroups.CLUTTER_BLOCKS);
    public static final Block BLUE_IRON_CANDELABRA = registerBlock("blue_iron_candelabra", new CandelabraBlock(FabricBlockSettings.copy(Blocks.IRON_BLOCK).luminance(CandelabraBlock.createLightLevelFromLitBlockState(12))), ModItemGroups.CLUTTER_BLOCKS);
    public static final Block PURPLE_IRON_CANDELABRA = registerBlock("purple_iron_candelabra", new CandelabraBlock(FabricBlockSettings.copy(Blocks.IRON_BLOCK).luminance(CandelabraBlock.createLightLevelFromLitBlockState(12))), ModItemGroups.CLUTTER_BLOCKS);
    public static final Block MAGENTA_IRON_CANDELABRA = registerBlock("magenta_iron_candelabra", new CandelabraBlock(FabricBlockSettings.copy(Blocks.IRON_BLOCK).luminance(CandelabraBlock.createLightLevelFromLitBlockState(12))), ModItemGroups.CLUTTER_BLOCKS);
    public static final Block PINK_IRON_CANDELABRA = registerBlock("pink_iron_candelabra", new CandelabraBlock(FabricBlockSettings.copy(Blocks.IRON_BLOCK).luminance(CandelabraBlock.createLightLevelFromLitBlockState(12))), ModItemGroups.CLUTTER_BLOCKS);
    ...
    public static final Block ONYX_ORE = registerBlock("onyx_ore", new ExperienceDroppingBlock(FabricBlockSettings.create().instrument(Instrument.BASEDRUM).strength(1.5f, 1.5f).mapColor(MapColor.TERRACOTTA_YELLOW).sounds(BlockSoundGroup.SAND), UniformIntProvider.create(3, 7)), ModItemGroups.CLUTTER_BLOCKS);
    public static final Block SULPHUR_BLOCK = registerBlock("sulphur_block", new Block(FabricBlockSettings.copy(ModBlocks.ONYX_ORE).mapColor(MapColor.PALE_YELLOW).sounds(BlockSoundGroup.SAND)), ModItemGroups.CLUTTER_BLOCKS);
    ...
    public static final Block PLATE = registerBlock("plate", new PlateBlock(FabricBlockSettings.copy(Blocks.WHITE_TERRACOTTA).breakInstantly()), ModItemGroups.CLUTTER_BLOCKS);
    ...
    public static final Block SMALL_LILY_PADS = registerBlockWithoutItem("small_lily_pads", new LilyPadBlock(FabricBlockSettings.copy(Blocks.LILY_PAD)));
