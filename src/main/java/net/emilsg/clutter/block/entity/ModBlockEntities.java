...
public class ModBlockEntities {
    ...
    public static void registerBlockEntities() {
        ...
        WALL_BOOKSHELF = Registry.register(Registry.BLOCK_ENTITY_TYPE, new Identifier(Clutter.MOD_ID, "wall_bookshelf"),
        ...
        WALL_CUPBOARD = Registry.register(Registry.BLOCK_ENTITY_TYPE, new Identifier(Clutter.MOD_ID, "wall_cupboard"),
        ...
        CUPBOARD = Registry.register(Registry.BLOCK_ENTITY_TYPE, new Identifier(Clutter.MOD_ID, "cupboard"),
        ...
        BONFIRE = Registry.register(Registry.BLOCK_ENTITY_TYPE, new Identifier(Clutter.MOD_ID, "bonfire"),
