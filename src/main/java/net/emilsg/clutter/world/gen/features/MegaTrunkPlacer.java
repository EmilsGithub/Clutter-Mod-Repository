...
public class MegaTrunkPlacer extends TrunkPlacer {
    public static final Codec<MegaTrunkPlacer> CODEC = RecordCodecBuilder.create(instance -> MegaTrunkPlacer.fillTrunkPlacerFields(instance).apply(instance, MegaTrunkPlacer::new));
