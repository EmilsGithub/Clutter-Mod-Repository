...
public class ModBlockTags {
    ...
    public static final TagKey<Block> BENCHES = TagKey.of(Registries.BLOCK.getKey(), new Identifier("clutter", "benches"));
    public static final TagKey<Block> STRIPPABLE_BENCHES = TagKey.of(Registries.BLOCK.getKey(), new Identifier("clutter", "strippable_benches"));
