...
import net.emilsg.clutter.mixin.CookingRecipeJsonBuilderMixin;
...
public class RecipeDataGen extends FabricRecipeProvider {
    ...
    protected RecipeGenerator getRecipeGenerator(RegistryWrapper.WrapperLookup wrapperLookup, RecipeExporter recipeExporter) {
        return new RecipeGenerator(wrapperLookup, recipeExporter) {
            ...
            public void generate() {
                createKilning(Items.SAND, Items.GLASS, 0.2f, 50, RecipeCategory.MISC, "glass");
                createKilning(Items.RED_SAND, Items.GLASS, 1, 50, RecipeCategory.MISC, "glass");
                createKilning(Items.CLAY_BALL, Items.BRICK, 1, 50, RecipeCategory.MISC, "brick");
                createKilning(Items.CLAY, Items.TERRACOTTA, 1, 50, RecipeCategory.MISC, "terracotta");
                createKilning(Items.CHORUS_FRUIT, Items.POPPED_CHORUS_FRUIT, 1, 50, RecipeCategory.MISC, "popped_chorus_fruit");
                createKilning(Items.NETHERRACK, Items.NETHER_BRICK, 1, 50, RecipeCategory.MISC, "nether_brick");
                createKilning(Items.COBBLESTONE, Items.STONE, 1, 50, RecipeCategory.MISC, "stone");
                createKilning(Items.STONE, Items.SMOOTH_STONE, 1, 50, RecipeCategory.MISC, "smooth_stone");
                createKilning(Items.COBBLED_DEEPSLATE, Items.DEEPSLATE, 1, 50, RecipeCategory.MISC, "deepslate");
                createKilning(Items.QUARTZ_BLOCK, Items.SMOOTH_QUARTZ, 1, 50, RecipeCategory.MISC, "smooth_quartz");
                createKilning(Items.BASALT, Items.SMOOTH_BASALT, 1, 50, RecipeCategory.MISC, "smooth_basalt");
                createKilning(Items.SANDSTONE, Items.SMOOTH_SANDSTONE, 1, 50, RecipeCategory.MISC, "smooth_sandstone");
                createKilning(Items.RED_SANDSTONE, Items.SMOOTH_RED_SANDSTONE, 1, 50, RecipeCategory.MISC, "smooth_red_sandstone");
                createKilning(Items.WHITE_TERRACOTTA, Items.WHITE_GLAZED_TERRACOTTA, 1, 50, RecipeCategory.MISC, "white_glazed_terracotta");
                createKilning(Items.LIGHT_GRAY_TERRACOTTA, Items.LIGHT_GRAY_GLAZED_TERRACOTTA, 1, 50, RecipeCategory.MISC, "light_gray_glazed_terracotta");
                createKilning(Items.GRAY_TERRACOTTA, Items.GRAY_GLAZED_TERRACOTTA, 1, 50, RecipeCategory.MISC, "gray_glazed_terracotta");
                createKilning(Items.BLACK_TERRACOTTA, Items.BLACK_GLAZED_TERRACOTTA, 1, 50, RecipeCategory.MISC, "black_glazed_terracotta");
                createKilning(Items.BROWN_TERRACOTTA, Items.BROWN_GLAZED_TERRACOTTA, 1, 50, RecipeCategory.MISC, "brown_glazed_terracotta");
                createKilning(Items.RED_TERRACOTTA, Items.RED_GLAZED_TERRACOTTA, 1, 50, RecipeCategory.MISC, "red_glazed_terracotta");
                createKilning(Items.ORANGE_TERRACOTTA, Items.ORANGE_GLAZED_TERRACOTTA, 1, 50, RecipeCategory.MISC, "orange_glazed_terracotta");
                createKilning(Items.YELLOW_TERRACOTTA, Items.YELLOW_GLAZED_TERRACOTTA, 1, 50, RecipeCategory.MISC, "yellow_glazed_terracotta");
                createKilning(Items.LIME_TERRACOTTA, Items.LIME_GLAZED_TERRACOTTA, 1, 50, RecipeCategory.MISC, "lime_glazed_terracotta");
                createKilning(Items.GREEN_TERRACOTTA, Items.GREEN_GLAZED_TERRACOTTA, 1, 50, RecipeCategory.MISC, "green_glazed_terracotta");
                createKilning(Items.CYAN_TERRACOTTA, Items.CYAN_GLAZED_TERRACOTTA, 1, 50, RecipeCategory.MISC, "cyan_glazed_terracotta");
                createKilning(Items.LIGHT_BLUE_TERRACOTTA, Items.LIGHT_BLUE_GLAZED_TERRACOTTA, 1, 50, RecipeCategory.MISC, "light_blue_glazed_terracotta");
                createKilning(Items.BLUE_TERRACOTTA, Items.BLUE_GLAZED_TERRACOTTA, 1, 50, RecipeCategory.MISC, "blue_glazed_terracotta");
                createKilning(Items.PURPLE_TERRACOTTA, Items.PURPLE_GLAZED_TERRACOTTA, 1, 50, RecipeCategory.MISC, "purple_glazed_terracotta");
                createKilning(Items.MAGENTA_TERRACOTTA, Items.MAGENTA_GLAZED_TERRACOTTA, 1, 50, RecipeCategory.MISC, "magenta_glazed_terracotta");
                createKilning(Items.PINK_TERRACOTTA, Items.PINK_GLAZED_TERRACOTTA, 1, 50, RecipeCategory.MISC, "pink_glazed_terracotta");
                ...
                this.createShaped(RecipeCategory.DECORATIONS, ModBlocks.QUARTZ_CRYSTAL)
                        .pattern("Q")
                        .pattern("Q")
                ...
                this.createShaped(RecipeCategory.BUILDING_BLOCKS, ModItems.AQUATIC_TORCH)
                        .pattern(" N ")
                        .pattern("NCN")
                        .pattern(" I ")
                ...
                this.createShaped(RecipeCategory.BUILDING_BLOCKS, ModItems.PRISMARINE_TORCH)
                        .pattern(" P ")
                        .pattern(" C ")
                        .pattern(" P ")
                ...
                this.createShaped(RecipeCategory.DECORATIONS, ModBlocks.TALL_BOTTLE)
                        .pattern(" G ")
                        .pattern(" G ")
                        .pattern("GDG")
                        .input('G', Items.GLASS)
                ...
                this.createShapeless(RecipeCategory.DECORATIONS, ModBlocks.LAB_BOTTLE)
                        .input(Items.GLASS_BOTTLE)
                        .criterion(hasItem(Items.GLASS_BOTTLE), conditionsFromItem(Items.GLASS_BOTTLE))
                        .criterion(hasItem(Items.GLASS), conditionsFromItem(Items.GLASS))
                        .offerTo(exporter);

                this.createShaped(RecipeCategory.MISC, ModBlocks.BRICK_KILN)
                        .pattern("SSS")
                        .pattern("BFB")
                        .pattern("BBB")
                ...
                this.createShaped(RecipeCategory.MISC, ModBlocks.CARDBOARD_BOX)
                        .pattern(" P ")
                        .pattern("PCP")
                        .pattern(" P ")
                        .input('P', Items.PAPER)
                ...
                this.createShaped(RecipeCategory.MISC, ModBlocks.RED_PRESENT)
                        .pattern("RPR")
                        .pattern("PCP")
                        .pattern("RPR")
                        .input('P', Items.PAPER)
                ...
                this.createShaped(RecipeCategory.MISC, ModBlocks.MAILBOX)
                        .pattern(" I ")
                        .pattern("ICI")
                        .pattern(" R ")
                ...
                this.createShaped(RecipeCategory.MISC, ModBlocks.PET_BED)
                        .pattern("WWW")
                        .input('W', ItemTags.WOOL)
                        .criterion(hasItem(Items.WHITE_WOOL), conditionsFromTag(ItemTags.WOOL))
                        .offerTo(exporter);

                this.createShaped(RecipeCategory.MISC, ModItems.PETTING_GLOVE)
                        .pattern(" LL")
                        .pattern("LLL")
                        .pattern(" WW")
                ...
                offerCompactingRecipe(RecipeCategory.BUILDING_BLOCKS, Blocks.WET_SPONGE, ModItems.SPONGE_SHARD);
                offer2x2CompactingRecipe(RecipeCategory.BUILDING_BLOCKS, ModBlocks.GLOWLILY_BLOCK, ModItems.GLOWLILY_BULB);
                ...
                this.createShapeless(RecipeCategory.MISC, ModItems.PROPELLER_CAP)
                        .input(ModItemTags.DYES)
                        .input(ModItemTags.DYES)
                        .input(ModItemTags.DYES)
                        .input(ModItems.CAP)
                ...
                this.createShapeless(RecipeCategory.MISC, ModItems.BUTTERFLY_WINGS)
                ...
                offerAllCookingRecipes(ModItems.THORNBLOOM_PEAR, ModItems.BAKED_THORNBLOOM_PEAR, 0.35f);
                offerAllCookingRecipes(ModItems.RAW_CHORUS_ECHOFIN, ModItems.COOKED_CHORUS_ECHOFIN, 0.35f);
                offerAllCookingRecipes(ModItems.RAW_LEVITATING_ECHOFIN, ModItems.COOKED_LEVITATING_ECHOFIN, 0.35f);
                offerAllCookingRecipes(ModItems.RAW_VENISON, ModItems.COOKED_VENISON, 0.35f);
                offerAllCookingRecipes(ModItems.RAW_VENISON_RIBS, ModItems.COOKED_VENISON_RIBS, 0.35f);
                ...
                offerStonecuttingRecipe(RecipeCategory.BUILDING_BLOCKS, ModBlocks.ONYX_SLAB, ModBlocks.ONYX_BLOCK, 2);
                offerStonecuttingRecipe(RecipeCategory.BUILDING_BLOCKS, ModBlocks.ONYX_STAIRS, ModBlocks.ONYX_BLOCK, 1);
                offerStonecuttingRecipe(RecipeCategory.BUILDING_BLOCKS, ModBlocks.ONYX_WALL, ModBlocks.ONYX_BLOCK, 1);
                offerStonecuttingRecipe(RecipeCategory.BUILDING_BLOCKS, ModBlocks.POLISHED_ONYX, ModBlocks.ONYX_BLOCK, 1);
                offerStonecuttingRecipe(RecipeCategory.BUILDING_BLOCKS, ModBlocks.POLISHED_ONYX_SLAB, ModBlocks.POLISHED_ONYX, 2);
                offerStonecuttingRecipe(RecipeCategory.BUILDING_BLOCKS, ModBlocks.POLISHED_ONYX_STAIRS, ModBlocks.POLISHED_ONYX, 1);
                offerStonecuttingRecipe(RecipeCategory.BUILDING_BLOCKS, ModBlocks.POLISHED_ONYX_WALL, ModBlocks.POLISHED_ONYX, 1);
                offerStonecuttingRecipe(RecipeCategory.BUILDING_BLOCKS, ModBlocks.BLACK_ONYX_SLAB, ModBlocks.BLACK_ONYX_BLOCK, 2);
                offerStonecuttingRecipe(RecipeCategory.BUILDING_BLOCKS, ModBlocks.BLACK_ONYX_STAIRS, ModBlocks.BLACK_ONYX_BLOCK, 1);
                offerStonecuttingRecipe(RecipeCategory.BUILDING_BLOCKS, ModBlocks.BLACK_ONYX_WALL, ModBlocks.BLACK_ONYX_BLOCK, 1);
                offerStonecuttingRecipe(RecipeCategory.BUILDING_BLOCKS, ModBlocks.POLISHED_BLACK_ONYX, ModBlocks.BLACK_ONYX_BLOCK, 1);
                offerStonecuttingRecipe(RecipeCategory.BUILDING_BLOCKS, ModBlocks.POLISHED_BLACK_ONYX_SLAB, ModBlocks.POLISHED_BLACK_ONYX, 2);
                offerStonecuttingRecipe(RecipeCategory.BUILDING_BLOCKS, ModBlocks.POLISHED_BLACK_ONYX_STAIRS, ModBlocks.POLISHED_BLACK_ONYX, 1);
                offerStonecuttingRecipe(RecipeCategory.BUILDING_BLOCKS, ModBlocks.POLISHED_BLACK_ONYX_WALL, ModBlocks.POLISHED_BLACK_ONYX, 1);
    ...
    public static CookingRecipeJsonBuilder createKilning(Item itemInput, ItemConvertible output, float experience, int cookingTime, RecipeCategory category, String group) {
        Ingredient input = Ingredient.ofItem(itemInput);
        return CookingRecipeJsonBuilder.create(input, category, output, experience, cookingTime, KilningRecipe.Serializer.INSTANCE, KilningRecipe::new).group(group);
    }

    public void offerAllCookingRecipes(Item component, Item result, float experience) {
        CookingRecipeJsonBuilder.createSmoking(Ingredient.ofItem(component), RecipeCategory.FOOD, result, experience, 100);
        CookingRecipeJsonBuilder.createSmelting(Ingredient.ofItem(component), RecipeCategory.FOOD, result, experience, 200);
        CookingRecipeJsonBuilder.createCampfireCooking(Ingredient.ofItem(component), RecipeCategory.FOOD, result, experience, 600);
    }

    public void offerAllSmeltingRecipes(RecipeExporter exporter, Item component, Item result, float experience, String group) {
        CookingRecipeJsonBuilder.createSmelting(Ingredient.ofItem(component), RecipeCategory.MISC, result, experience, 200);
        CookingRecipeJsonBuilder.createBlasting(Ingredient.ofItem(component), RecipeCategory.MISC, result, experience, 100);
    }
    ...
    public void offerDecoratedElytraRecipes(RecipeExporter exporter, Item result, Item addition) {
        SmithingTransformRecipeJsonBuilder
                ...
                .criterion("has_elytra", RecipeGenerator.conditionsFromItem(ModItems.BUTTERFLY_IN_A_BOTTLE))
                .offerTo(exporter, String.valueOf(Identifier.of(Clutter.MOD_ID, RecipeGenerator.getRecipeName(result))));
    }
    ...
    public String getName() {
        return Identifier.of(Clutter.MOD_ID,"recipe_provider").toString();
    }
}
