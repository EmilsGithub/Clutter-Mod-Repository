...
public class BrickKilnScreen extends AbstractFurnaceScreen<BrickKilnScreenHandler> {
    ...
    private static final Identifier LIT_PROGRESS_TEXTURE = Identifier.of("minecraft","container/furnace/lit_progress");
    private static final Identifier BURN_PROGRESS_TEXTURE = Identifier.of("minecraft","container/furnace/burn_progress");
