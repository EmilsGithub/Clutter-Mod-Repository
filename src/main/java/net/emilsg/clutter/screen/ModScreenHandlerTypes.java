...
public class ModScreenHandlerTypes {
    ...
    public static final ScreenHandlerType<ShelfScreenHandler> SHELF_SCREEN_HANDLER =
            Registry.register(Registries.SCREEN_HANDLER, Identifier.of(Clutter.MOD_ID, "shelf_screen_handler"),
                    new ExtendedScreenHandlerType<>(ShelfScreenHandler::new, BlockPos.PACKET_CODEC));
