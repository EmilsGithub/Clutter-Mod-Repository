...
public class JellyfishEntity extends WaterCreatureEntity {
    ...
    public void tickMovement() {
        ...
        if (this.isAlive()) {
            List<LivingEntity> list = this.getWorld().getEntitiesByClass(LivingEntity.class, this.getBoundingBox().expand(0.3), entity -> TARGET_PREDICATE.test(this, (LivingEntity)entity));
