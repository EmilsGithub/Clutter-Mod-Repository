...
public class CrimsonNewtAnimations {

    public static final Animation CRIMSON_NEWT_WALK = Animation.Builder.create(0.5f).looping()
    ...
    public static final Animation CRIMSON_NEWT_IDLE = Animation.Builder.create(4f).looping()
            .addBoneAnimation("Mushroom",
                    new Transformation(Transformation.Targets.ROTATE,
